...
80102151:	e8 3a 21 00 00       	call   80104290 <wakeup>
...
80102d72:	00 00 00 
    wakeup(&log);
80102d75:	e8 16 15 00 00       	call   80104290 <wakeup>
    release(&log.lock);
...
80102da0:	e8 eb 14 00 00       	call   80104290 <wakeup>
  release(&log.lock);
...
801033df:	e8 ac 0e 00 00       	call   80104290 <wakeup>
...
80103424:	e8 67 0e 00 00       	call   80104290 <wakeup>
...
801034b4:	e8 d7 0d 00 00       	call   80104290 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801034b9:	5a                   	pop    %edx
801034ba:	59                   	pop    %ecx
...
80103637:	e8 54 0c 00 00       	call   80104290 <wakeup>
  release(&p->lock);
...
8010369f:	74 25                	je     801036c6 <wakeup1+0x66>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801036a1:	81 c2 0c 01 00 00    	add    $0x10c,%edx
801036a7:	81 fa 54 80 11 80    	cmp    $0x80118054,%edx
...
801036e1:	74 9d                	je     80103680 <wakeup1+0x20>
        p->chan = 0;
801036e3:	c7 42 20 00 00 00 00 	movl   $0x0,0x20(%edx)
801036ea:	89 d8                	mov    %ebx,%eax
801036ec:	be 05 00 00 00       	mov    $0x5,%esi
801036f1:	f0 0f b1 31          	lock cmpxchg %esi,(%ecx)
801036f5:	9c                   	pushf  
801036f6:	58                   	pop    %eax
801036f7:	c1 e8 06             	shr    $0x6,%eax
801036fa:	83 e0 01             	and    $0x1,%eax
801036fd:	89 c6                	mov    %eax,%esi
801036ff:	e9 7c ff ff ff       	jmp    80103680 <wakeup1+0x20>
...
80103713:	83 ec 08             	sub    $0x8,%esp
  popcli();
80103716:	e8 75 12 00 00       	call   80104990 <popcli>
  if (first) {
...
80103766:	68 d5 7b 10 80       	push   $0x80107bd5
8010376b:	68 20 3d 11 80       	push   $0x80113d20
80103770:	e8 6b 11 00 00       	call   801048e0 <initlock>
}
...
80103824:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103827:	e8 24 11 00 00       	call   80104950 <pushcli>
  c = mycpu();
8010382c:	e8 4f ff ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103831:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103837:	e8 54 11 00 00       	call   80104990 <popcli>
}
...
80103854:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    pid = nextpid;
80103858:	8b 0d 04 b0 10 80    	mov    0x8010b004,%ecx
  }while(!cas((int*)(&nextpid), pid, pid + 1));
8010385e:	8d 51 01             	lea    0x1(%ecx),%edx
  asm volatile(
80103861:	89 c8                	mov    %ecx,%eax
80103863:	f0 0f b1 15 04 b0 10 	lock cmpxchg %edx,0x8010b004
8010386a:	80 
8010386b:	9c                   	pushf  
8010386c:	58                   	pop    %eax
8010386d:	c1 e8 06             	shr    $0x6,%eax
80103870:	83 e0 01             	and    $0x1,%eax
80103873:	89 c2                	mov    %eax,%edx
80103875:	85 d2                	test   %edx,%edx
80103877:	74 df                	je     80103858 <allocpid+0x8>
}
80103879:	89 c8                	mov    %ecx,%eax
8010387b:	5d                   	pop    %ebp
8010387c:	c3                   	ret    
...
8010389f:	90                   	nop
801038a0:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
801038a6:	81 fb 54 80 11 80    	cmp    $0x80118054,%ebx
...
801038b5:	81 fb 54 80 11 80    	cmp    $0x80118054,%ebx
...
801038d6:	e8 b5 10 00 00       	call   80104990 <popcli>
  p->pid = allocpid();
801038db:	e8 70 ff ff ff       	call   80103850 <allocpid>
...
80103917:	8d 93 04 01 00 00    	lea    0x104(%ebx),%edx
8010391d:	83 c4 10             	add    $0x10,%esp
80103920:	c7 40 10 10 37 10 80 	movl   $0x80103710,0x10(%eax)
80103927:	8d 83 84 00 00 00    	lea    0x84(%ebx),%eax
  p->psignals = 0;
...
80103a68:	e8 e3 0e 00 00       	call   80104950 <pushcli>
  c = mycpu();
80103a6d:	e8 0e fd ff ff       	call   80103780 <mycpu>
  p = c->proc;
...
80103ae9:	e8 62 0e 00 00       	call   80104950 <pushcli>
  c = mycpu();
80103aee:	e8 8d fc ff ff       	call   80103780 <mycpu>
  p = c->proc;
...
80103b42:	8d b3 84 00 00 00    	lea    0x84(%ebx),%esi
80103b48:	8d 8a 84 00 00 00    	lea    0x84(%edx),%ecx
...
80103c62:	8b 84 8e 84 00 00 00 	mov    0x84(%esi,%ecx,4),%eax
...
80103ccd:	8d 76 00             	lea    0x0(%esi),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cd0:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
80103cd6:	81 fb 54 80 11 80    	cmp    $0x80118054,%ebx
...
80103cfd:	74 d1                	je     80103cd0 <scheduler+0x40>
      if(p->frozen)
80103cff:	8b 8b 08 01 00 00    	mov    0x108(%ebx),%ecx
...
80103dcc:	8b 43 14             	mov    0x14(%ebx),%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dcf:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
            wakeup1(p->parent); // DELAYED WAKEUP UNTIL process is actually zombie!
80103dd5:	e8 86 f8 ff ff       	call   80103660 <wakeup1>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dda:	81 fb 54 80 11 80    	cmp    $0x80118054,%ebx
...
80103e53:	75 41                	jne    80103e96 <sched+0x76>
  intena = mycpu()->intena;
80103e55:	e8 26 f9 ff ff       	call   80103780 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e5a:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103e5d:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e63:	e8 18 f9 ff ff       	call   80103780 <mycpu>
...
80103eb9:	e8 92 0a 00 00       	call   80104950 <pushcli>
  c = mycpu();
80103ebe:	e8 bd f8 ff ff       	call   80103780 <mycpu>
  p = c->proc;
...
80103f49:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f50:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
80103f56:	81 fb 54 80 11 80    	cmp    $0x80118054,%ebx
...
80103f6f:	75 df                	jne    80103f50 <exit+0xa0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f71:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
        wakeup1(initproc);
80103f77:	e8 e4 f6 ff ff       	call   80103660 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f7c:	81 fb 54 80 11 80    	cmp    $0x80118054,%ebx
...
80103fb9:	e8 92 09 00 00       	call   80104950 <pushcli>
  c = mycpu();
80103fbe:	e8 bd f7 ff ff       	call   80103780 <mycpu>
  p = c->proc;
...
80104010:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
80104016:	81 fb 54 80 11 80    	cmp    $0x80118054,%ebx
...
8010403c:	75 62                	jne    801040a0 <wait+0xf0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010403e:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
      havekids = 1;
80104044:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104049:	81 fb 54 80 11 80    	cmp    $0x80118054,%ebx
...
8010417c:	e8 cf 07 00 00       	call   80104950 <pushcli>
  c = mycpu();
80104181:	e8 fa f5 ff ff       	call   80103780 <mycpu>
  p = c->proc;
...
801041df:	e8 6c 07 00 00       	call   80104950 <pushcli>
  c = mycpu();
801041e4:	e8 97 f5 ff ff       	call   80103780 <mycpu>
  p = c->proc;
...
801041fe:	74 76                	je     80104276 <sleep+0xa6>
  pushcli();
80104200:	e8 4b 07 00 00       	call   80104950 <pushcli>
  p->chan = chan;
80104205:	89 7b 20             	mov    %edi,0x20(%ebx)
80104208:	b8 07 00 00 00       	mov    $0x7,%eax
8010420d:	ba 04 00 00 00       	mov    $0x4,%edx
80104212:	f0 0f b1 53 0c       	lock cmpxchg %edx,0xc(%ebx)
80104217:	9c                   	pushf  
80104218:	58                   	pop    %eax
80104219:	c1 e8 06             	shr    $0x6,%eax
8010421c:	83 e0 01             	and    $0x1,%eax
8010421f:	89 c2                	mov    %eax,%edx
  if(!cas((int*)(&p->state), RUNNING, MINUS_SLEEPING)) // c_check
80104221:	85 d2                	test   %edx,%edx
80104223:	74 44                	je     80104269 <sleep+0x99>
  if(lk != &ptable.lock){  //DOC: sleeplock0
80104225:	81 fe 20 3d 11 80    	cmp    $0x80113d20,%esi
8010422b:	74 2b                	je     80104258 <sleep+0x88>
    release(lk);
8010422d:	83 ec 0c             	sub    $0xc,%esp
80104230:	56                   	push   %esi
80104231:	e8 aa 08 00 00       	call   80104ae0 <release>
  sched();
80104236:	e8 e5 fb ff ff       	call   80103e20 <sched>
    acquire(lk);
...
80104252:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  sched();
80104258:	e8 c3 fb ff ff       	call   80103e20 <sched>
}
8010425d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104260:	5b                   	pop    %ebx
80104261:	5e                   	pop    %esi
80104262:	5f                   	pop    %edi
80104263:	5d                   	pop    %ebp
  popcli();
80104264:	e9 27 07 00 00       	jmp    80104990 <popcli>
    panic("cas failed at sleeping, should be running state!");
80104269:	83 ec 0c             	sub    $0xc,%esp
8010426c:	68 9c 7d 10 80       	push   $0x80107d9c
80104271:	e8 1a c1 ff ff       	call   80100390 <panic>
    panic("sleep without lk");
80104276:	83 ec 0c             	sub    $0xc,%esp
80104279:	68 77 7c 10 80       	push   $0x80107c77
8010427e:	e8 0d c1 ff ff       	call   80100390 <panic>
    panic("sleep");
80104283:	83 ec 0c             	sub    $0xc,%esp
80104286:	68 71 7c 10 80       	push   $0x80107c71
...
80104297:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010429a:	e8 b1 06 00 00       	call   80104950 <pushcli>
  wakeup1(chan);
8010429f:	89 d8                	mov    %ebx,%eax
801042a1:	e8 ba f3 ff ff       	call   80103660 <wakeup1>
}
801042a6:	83 c4 04             	add    $0x4,%esp
801042a9:	5b                   	pop    %ebx
801042aa:	5d                   	pop    %ebp
  popcli();
801042ab:	e9 e0 06 00 00       	jmp    80104990 <popcli>
...
801042b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
801042bc:	8b 75 08             	mov    0x8(%ebp),%esi
  if(signum < SIG_MIN || signum > SIG_MAX)
801042bf:	83 fb 1f             	cmp    $0x1f,%ebx
801042c2:	0f 87 7c 00 00 00    	ja     80104344 <kill+0x94>
  pushcli();
801042c8:	e8 83 06 00 00       	call   80104950 <pushcli>
      int expected_on = p->psignals | (1 << signum);
801042cd:	bf 01 00 00 00       	mov    $0x1,%edi
801042d2:	89 d9                	mov    %ebx,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042d4:	ba 54 3d 11 80       	mov    $0x80113d54,%edx
      int expected_on = p->psignals | (1 << signum);
801042d9:	d3 e7                	shl    %cl,%edi
801042db:	eb 11                	jmp    801042ee <kill+0x3e>
801042dd:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042e0:	81 c2 0c 01 00 00    	add    $0x10c,%edx
801042e6:	81 fa 54 80 11 80    	cmp    $0x80118054,%edx
801042ec:	73 42                	jae    80104330 <kill+0x80>
    if(p->pid == pid)
801042ee:	39 72 10             	cmp    %esi,0x10(%edx)
801042f1:	75 ed                	jne    801042e0 <kill+0x30>
      int expected_on = p->psignals | (1 << signum);
801042f3:	8b 42 7c             	mov    0x7c(%edx),%eax
801042f6:	09 f8                	or     %edi,%eax
801042f8:	f0 0f b1 42 7c       	lock cmpxchg %eax,0x7c(%edx)
801042fd:	9c                   	pushf  
801042fe:	58                   	pop    %eax
801042ff:	c1 e8 06             	shr    $0x6,%eax
80104302:	83 e0 01             	and    $0x1,%eax
80104305:	89 c1                	mov    %eax,%ecx
      if(!cas((int*)(&p->psignals), expected_on, expected_on))
80104307:	85 c9                	test   %ecx,%ecx
80104309:	75 d5                	jne    801042e0 <kill+0x30>
        if(signum != 1)
8010430b:	83 fb 01             	cmp    $0x1,%ebx
8010430e:	74 03                	je     80104313 <kill+0x63>
          p->psignals |= (1 << signum);
80104310:	09 7a 7c             	or     %edi,0x7c(%edx)
80104313:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
        popcli();
80104316:	e8 75 06 00 00       	call   80104990 <popcli>
        return 0;
8010431b:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
}
8010431e:	83 c4 1c             	add    $0x1c,%esp
80104321:	89 c8                	mov    %ecx,%eax
80104323:	5b                   	pop    %ebx
80104324:	5e                   	pop    %esi
80104325:	5f                   	pop    %edi
80104326:	5d                   	pop    %ebp
...
80104329:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  popcli();
80104330:	e8 5b 06 00 00       	call   80104990 <popcli>
}
80104335:	83 c4 1c             	add    $0x1c,%esp
  return -1;
80104338:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
}
8010433d:	5b                   	pop    %ebx
8010433e:	89 c8                	mov    %ecx,%eax
80104340:	5e                   	pop    %esi
80104341:	5f                   	pop    %edi
80104342:	5d                   	pop    %ebp
80104343:	c3                   	ret    
    return -1;
80104344:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
80104349:	eb d3                	jmp    8010431e <kill+0x6e>
8010434b:	90                   	nop
8010434c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80104350 <sigprocmask>:
{
...
80104354:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104357:	e8 f4 05 00 00       	call   80104950 <pushcli>
  c = mycpu();
8010435c:	e8 1f f4 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80104361:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104367:	e8 24 06 00 00       	call   80104990 <popcli>
  curproc->sigmask = mask;
8010436c:	8b 55 08             	mov    0x8(%ebp),%edx
  uint old = curproc -> sigmask;
8010436f:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
  curproc->sigmask = mask;
80104375:	89 93 80 00 00 00    	mov    %edx,0x80(%ebx)
}
8010437b:	83 c4 04             	add    $0x4,%esp
8010437e:	5b                   	pop    %ebx
8010437f:	5d                   	pop    %ebp
80104380:	c3                   	ret    
80104381:	eb 0d                	jmp    80104390 <procdump>
80104383:	90                   	nop
80104384:	90                   	nop
80104385:	90                   	nop
80104386:	90                   	nop
...
80104396:	8d 75 e8             	lea    -0x18(%ebp),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104399:	bb 54 3d 11 80       	mov    $0x80113d54,%ebx
{
...
801043ab:	68 03 81 10 80       	push   $0x80108103
801043b0:	e8 ab c2 ff ff       	call   80100660 <cprintf>
801043b5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043b8:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
801043be:	81 fb 54 80 11 80    	cmp    $0x80118054,%ebx
801043c4:	0f 83 86 00 00 00    	jae    80104450 <procdump+0xc0>
    if(p->state == UNUSED)
801043ca:	8b 43 0c             	mov    0xc(%ebx),%eax
801043cd:	85 c0                	test   %eax,%eax
801043cf:	74 e7                	je     801043b8 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801043d1:	83 f8 09             	cmp    $0x9,%eax
      state = "???";
801043d4:	ba 88 7c 10 80       	mov    $0x80107c88,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801043d9:	77 11                	ja     801043ec <procdump+0x5c>
801043db:	8b 14 85 e0 7d 10 80 	mov    -0x7fef8220(,%eax,4),%edx
      state = "???";
801043e2:	b8 88 7c 10 80       	mov    $0x80107c88,%eax
801043e7:	85 d2                	test   %edx,%edx
801043e9:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801043ec:	8d 43 6c             	lea    0x6c(%ebx),%eax
801043ef:	50                   	push   %eax
801043f0:	52                   	push   %edx
801043f1:	ff 73 10             	pushl  0x10(%ebx)
801043f4:	68 8c 7c 10 80       	push   $0x80107c8c
801043f9:	e8 62 c2 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
801043fe:	83 c4 10             	add    $0x10,%esp
80104401:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80104405:	75 a1                	jne    801043a8 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104407:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010440a:	83 ec 08             	sub    $0x8,%esp
8010440d:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104410:	50                   	push   %eax
80104411:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104414:	8b 40 0c             	mov    0xc(%eax),%eax
80104417:	83 c0 08             	add    $0x8,%eax
8010441a:	50                   	push   %eax
8010441b:	e8 e0 04 00 00       	call   80104900 <getcallerpcs>
80104420:	83 c4 10             	add    $0x10,%esp
80104423:	90                   	nop
80104424:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      for(i=0; i<10 && pc[i] != 0; i++)
80104428:	8b 17                	mov    (%edi),%edx
8010442a:	85 d2                	test   %edx,%edx
8010442c:	0f 84 76 ff ff ff    	je     801043a8 <procdump+0x18>
        cprintf(" %p", pc[i]);
80104432:	83 ec 08             	sub    $0x8,%esp
80104435:	83 c7 04             	add    $0x4,%edi
80104438:	52                   	push   %edx
80104439:	68 c1 76 10 80       	push   $0x801076c1
8010443e:	e8 1d c2 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104443:	83 c4 10             	add    $0x10,%esp
80104446:	39 fe                	cmp    %edi,%esi
80104448:	75 de                	jne    80104428 <procdump+0x98>
8010444a:	e9 59 ff ff ff       	jmp    801043a8 <procdump+0x18>
8010444f:	90                   	nop
}
80104450:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104453:	5b                   	pop    %ebx
80104454:	5e                   	pop    %esi
80104455:	5f                   	pop    %edi
80104456:	5d                   	pop    %ebp
...
80104464:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104467:	e8 e4 04 00 00       	call   80104950 <pushcli>
  c = mycpu();
8010446c:	e8 0f f3 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80104471:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104477:	e8 14 05 00 00       	call   80104990 <popcli>
  if(p->state == SLEEPING)
8010447c:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
  p->killed = 1;
80104480:	c7 43 24 01 00 00 00 	movl   $0x1,0x24(%ebx)
  if(p->state == SLEEPING)
80104487:	75 19                	jne    801044a2 <sigkill_handler+0x42>
80104489:	b8 03 00 00 00       	mov    $0x3,%eax
8010448e:	ba 05 00 00 00       	mov    $0x5,%edx
80104493:	f0 0f b1 53 0c       	lock cmpxchg %edx,0xc(%ebx)
80104498:	9c                   	pushf  
80104499:	58                   	pop    %eax
8010449a:	c1 e8 06             	shr    $0x6,%eax
8010449d:	83 e0 01             	and    $0x1,%eax
801044a0:	89 c2                	mov    %eax,%edx
}
801044a2:	83 c4 04             	add    $0x4,%esp
801044a5:	5b                   	pop    %ebx
801044a6:	5d                   	pop    %ebp
801044a7:	c3                   	ret    
801044a8:	90                   	nop
...
801044cc:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
  p->frozen = 1;
801044d0:	c7 83 08 01 00 00 01 	movl   $0x1,0x108(%ebx)
801044d7:	00 00 00 
  if(p-> state == SLEEPING)
801044da:	75 19                	jne    801044f5 <sigstop_handler+0x45>
801044dc:	b8 03 00 00 00       	mov    $0x3,%eax
801044e1:	ba 05 00 00 00       	mov    $0x5,%edx
801044e6:	f0 0f b1 53 0c       	lock cmpxchg %edx,0xc(%ebx)
801044eb:	9c                   	pushf  
801044ec:	58                   	pop    %eax
801044ed:	c1 e8 06             	shr    $0x6,%eax
801044f0:	83 e0 01             	and    $0x1,%eax
801044f3:	89 c2                	mov    %eax,%edx
}
...
80104504:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104507:	e8 44 04 00 00       	call   80104950 <pushcli>
  c = mycpu();
8010450c:	e8 6f f2 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80104511:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104517:	e8 74 04 00 00       	call   80104990 <popcli>
  p->frozen = 0;
8010451c:	c7 83 08 01 00 00 00 	movl   $0x0,0x108(%ebx)
80104523:	00 00 00 
}
...
8010453c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    new_sighandlers[i] = old_sighandlers[i];
80104540:	8b 14 81             	mov    (%ecx,%eax,4),%edx
80104543:	89 14 83             	mov    %edx,(%ebx,%eax,4)
  for(i = 0; i < SIG_HANDLERS_NUM; i++) {
80104546:	83 c0 01             	add    $0x1,%eax
80104549:	83 f8 20             	cmp    $0x20,%eax
8010454c:	75 f2                	jne    80104540 <copySigHandlers+0x10>
  }
}
8010454e:	5b                   	pop    %ebx
8010454f:	5d                   	pop    %ebp
80104550:	c3                   	ret    
80104551:	eb 0d                	jmp    80104560 <sigaction>
80104553:	90                   	nop
80104554:	90                   	nop
80104555:	90                   	nop
80104556:	90                   	nop
...
8010456c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  pushcli();
8010456f:	e8 dc 03 00 00       	call   80104950 <pushcli>
  c = mycpu();
80104574:	e8 07 f2 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80104579:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
8010457f:	e8 0c 04 00 00       	call   80104990 <popcli>
  struct proc* curproc = myproc();

  if(signum == SIGSTOP || signum == SIGKILL) // they cannot be modified, blocked or ignored
80104584:	8d 56 f7             	lea    -0x9(%esi),%edx
80104587:	b8 01 00 00 00       	mov    $0x1,%eax
8010458c:	83 e2 f7             	and    $0xfffffff7,%edx
8010458f:	74 2f                	je     801045c0 <sigaction+0x60>
    return 1;

  if(oldact != null) {
80104591:	8b 4d 10             	mov    0x10(%ebp),%ecx
80104594:	8d 84 b7 84 00 00 00 	lea    0x84(%edi,%esi,4),%eax
8010459b:	85 c9                	test   %ecx,%ecx
8010459d:	74 0d                	je     801045ac <sigaction+0x4c>
...
801045d6:	83 ec 10             	sub    $0x10,%esp
...
801045df:	6a 4c                	push   $0x4c
801045e1:	ff 73 18             	pushl  0x18(%ebx)
801045e4:	ff 73 08             	pushl  0x8(%ebx)
801045e7:	e8 f4 05 00 00       	call   80104be0 <memmove>
    p->tf_backup = (struct trapframe*)p->kstack;
801045ec:	8b 43 08             	mov    0x8(%ebx),%eax
...
801045ef:	8b 53 18             	mov    0x18(%ebx),%edx

    sigret_caller_addr = (char*)p->tf->esp;

    memmove((char*)p->tf->esp, sigret_caller_start, sigret_size);
801045f2:	83 c4 0c             	add    $0xc,%esp
    p->tf_backup = (struct trapframe*)p->kstack;
801045f5:	89 83 04 01 00 00    	mov    %eax,0x104(%ebx)
    sigret_size = sigret_caller_end - sigret_caller_start;
801045fb:	b8 0c 5e 10 80       	mov    $0x80105e0c,%eax
80104600:	2d 05 5e 10 80       	sub    $0x80105e05,%eax
    p->tf->esp = p->tf->esp - sigret_size; // make room for sigret code
80104605:	29 42 44             	sub    %eax,0x44(%edx)
    sigret_caller_addr = (char*)p->tf->esp;
80104608:	8b 53 18             	mov    0x18(%ebx),%edx
8010460b:	8b 7a 44             	mov    0x44(%edx),%edi
    memmove((char*)p->tf->esp, sigret_caller_start, sigret_size);
8010460e:	50                   	push   %eax
8010460f:	68 05 5e 10 80       	push   $0x80105e05
80104614:	57                   	push   %edi
80104615:	e8 c6 05 00 00       	call   80104be0 <memmove>

    // pushing signum
    p->tf->esp = p->tf->esp-UINT_SIZE;
8010461a:	8b 43 18             	mov    0x18(%ebx),%eax
    p->tf->esp = p->tf->esp-UINT_SIZE;
...
8010461d:	83 c4 10             	add    $0x10,%esp
    p->tf->esp = p->tf->esp-UINT_SIZE;
80104620:	83 68 44 04          	subl   $0x4,0x44(%eax)
    *((uint*)(p->tf->esp)) = sig;
80104624:	8b 43 18             	mov    0x18(%ebx),%eax
80104627:	8b 40 44             	mov    0x44(%eax),%eax
8010462a:	89 30                	mov    %esi,(%eax)
    p->tf->esp = p->tf->esp-UINT_SIZE;
8010462c:	8b 43 18             	mov    0x18(%ebx),%eax
8010462f:	83 68 44 04          	subl   $0x4,0x44(%eax)
    *((uint*)(p->tf->esp)) = (uint)sigret_caller_addr;
80104633:	8b 43 18             	mov    0x18(%ebx),%eax
80104636:	8b 40 44             	mov    0x44(%eax),%eax
80104639:	89 38                	mov    %edi,(%eax)
    p->tf->eip = (uint)&((struct sigaction*)p->sig_handlers[sig])->sa_handler;
8010463b:	8b 94 b3 84 00 00 00 	mov    0x84(%ebx,%esi,4),%edx
80104642:	8b 43 18             	mov    0x18(%ebx),%eax
80104645:	89 50 38             	mov    %edx,0x38(%eax)
}
...
80104655:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104658:	e8 f3 02 00 00       	call   80104950 <pushcli>
  c = mycpu();
8010465d:	e8 1e f1 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80104662:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104668:	e8 23 03 00 00       	call   80104990 <popcli>
  struct proc *p = myproc();
  if(p->sig_handlers[sig] == SIG_IGN)
8010466d:	8b 84 9e 84 00 00 00 	mov    0x84(%esi,%ebx,4),%eax
80104674:	83 f8 01             	cmp    $0x1,%eax
80104677:	74 11                	je     8010468a <handleSignal+0x3a>
  {
    // do nothing
  }
...
8010467b:	74 1b                	je     80104698 <handleSignal+0x48>
    ...
    user_handler(p, sig);
8010467d:	83 ec 08             	sub    $0x8,%esp
80104680:	53                   	push   %ebx
80104681:	56                   	push   %esi
80104682:	e8 49 ff ff ff       	call   801045d0 <user_handler>
...
80104691:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    switch (sig) 
80104698:	83 fb 11             	cmp    $0x11,%ebx
8010469b:	74 23                	je     801046c0 <handleSignal+0x70>
8010469d:	83 fb 13             	cmp    $0x13,%ebx
801046a0:	75 0e                	jne    801046b0 <handleSignal+0x60>
}
...
801046a7:	5d                   	pop    %ebp
        sigcont_handler();
801046a8:	e9 53 fe ff ff       	jmp    80104500 <sigcont_handler>
...
801046b5:	5d                   	pop    %ebp
        sigkill_handler();
801046b6:	e9 a5 fd ff ff       	jmp    80104460 <sigkill_handler>
801046bb:	90                   	nop
...
801046c5:	5d                   	pop    %ebp
        sigstop_handler();
801046c6:	e9 e5 fd ff ff       	jmp    801044b0 <sigstop_handler>
801046cb:	90                   	nop
...
801046d5:	83 ec 10             	sub    $0x10,%esp
  pushcli();
801046d8:	e8 73 02 00 00       	call   80104950 <pushcli>
  c = mycpu();
801046dd:	e8 9e f0 ff ff       	call   80103780 <mycpu>
  p = c->proc;
801046e2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801046e8:	e8 a3 02 00 00       	call   80104990 <popcli>
  struct proc *p = myproc();
  uint sig;

  if(p == 0)
801046ed:	85 db                	test   %ebx,%ebx
801046ef:	74 10                	je     80104701 <handle_signals+0x31>
    return;
  
  if ((tf->cs & 3) != DPL_USER)
801046f1:	8b 45 08             	mov    0x8(%ebp),%eax
801046f4:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801046f8:	83 e0 03             	and    $0x3,%eax
801046fb:	66 83 f8 03          	cmp    $0x3,%ax
801046ff:	74 0f                	je     80104710 <handle_signals+0x40>
  //   }
  }
  // popcli();
  // release(&ptable.lock);
...
80104701:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104704:	5b                   	pop    %ebx
80104705:	5e                   	pop    %esi
80104706:	5d                   	pop    %ebp
80104707:	c3                   	ret    
...
80104709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for (sig = SIG_MIN; sig <= SIG_MAX; sig++) {
80104710:	31 c9                	xor    %ecx,%ecx
  if(p->sigmask & (1 << sig))
80104712:	be 01 00 00 00       	mov    $0x1,%esi
80104717:	eb 0f                	jmp    80104728 <handle_signals+0x58>
80104719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for (sig = SIG_MIN; sig <= SIG_MAX; sig++) {
80104720:	83 c1 01             	add    $0x1,%ecx
80104723:	83 f9 20             	cmp    $0x20,%ecx
80104726:	74 d9                	je     80104701 <handle_signals+0x31>
  if(p->sigmask & (1 << sig))
80104728:	89 f2                	mov    %esi,%edx
8010472a:	d3 e2                	shl    %cl,%edx
8010472c:	85 93 80 00 00 00    	test   %edx,0x80(%ebx)
80104732:	75 ec                	jne    80104720 <handle_signals+0x50>
  int expected = p->psignals | (1 << sig) ;
80104734:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104737:	09 d0                	or     %edx,%eax
  if(cas((int*)(&p->psignals), expected, expected ^ (1 << sig)))
80104739:	31 c2                	xor    %eax,%edx
8010473b:	f0 0f b1 53 7c       	lock cmpxchg %edx,0x7c(%ebx)
80104740:	9c                   	pushf  
80104741:	58                   	pop    %eax
80104742:	c1 e8 06             	shr    $0x6,%eax
80104745:	83 e0 01             	and    $0x1,%eax
80104748:	89 c2                	mov    %eax,%edx
8010474a:	85 d2                	test   %edx,%edx
8010474c:	74 d2                	je     80104720 <handle_signals+0x50>
    handleSignal(sig);           // handle it
8010474e:	83 ec 0c             	sub    $0xc,%esp
80104751:	89 4d f4             	mov    %ecx,-0xc(%ebp)
80104754:	51                   	push   %ecx
80104755:	e8 f6 fe ff ff       	call   80104650 <handleSignal>
8010475a:	83 c4 10             	add    $0x10,%esp
8010475d:	8b 4d f4             	mov    -0xc(%ebp),%ecx
80104760:	eb be                	jmp    80104720 <handle_signals+0x50>
...
80104774:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104777:	e8 d4 01 00 00       	call   80104950 <pushcli>
  c = mycpu();
8010477c:	e8 ff ef ff ff       	call   80103780 <mycpu>
  p = c->proc;
80104781:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104787:	e8 04 02 00 00       	call   80104990 <popcli>
  struct proc* p = myproc();
  memmove(p->tf, p->tf_backup, sizeof(struct trapframe)); // trapframe restore
8010478c:	83 ec 04             	sub    $0x4,%esp
8010478f:	6a 4c                	push   $0x4c
80104791:	ff b3 04 01 00 00    	pushl  0x104(%ebx)
80104797:	ff 73 18             	pushl  0x18(%ebx)
8010479a:	e8 41 04 00 00       	call   80104be0 <memmove>
  handle_signals(p->tf);
8010479f:	58                   	pop    %eax
801047a0:	ff 73 18             	pushl  0x18(%ebx)
801047a3:	e8 28 ff ff ff       	call   801046d0 <handle_signals>
  return 0;
...
80104823:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104829:	e8 f2 ef ff ff       	call   80103820 <myproc>
...
80104874:	e8 17 fa ff ff       	call   80104290 <wakeup>
  release(&lk->lk);
...
801048b3:	e8 68 ef ff ff       	call   80103820 <myproc>
...
80104959:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010495a:	e8 21 ee ff ff       	call   80103780 <mycpu>
...
8010496f:	e8 0c ee ff ff       	call   80103780 <mycpu>
...
801049bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801049c0:	e8 bb ed ff ff       	call   80103780 <mycpu>
...
80104a08:	e8 73 ed ff ff       	call   80103780 <mycpu>
...
80104a64:	e8 17 ed ff ff       	call   80103780 <mycpu>
...
80104d87:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104d8a:	e8 91 ea ff ff       	call   80103820 <myproc>
...
80104e43:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104e46:	e8 d5 e9 ff ff       	call   80103820 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104e88:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104e8b:	e8 90 e9 ff ff       	call   80103820 <myproc>
...
80104f24:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104f27:	e8 f4 e8 ff ff       	call   80103820 <myproc>
...
80105144:	e8 d7 e6 ff ff       	call   80103820 <myproc>
...
80105189:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010518b:	e8 90 e6 ff ff       	call   80103820 <myproc>
...
8010570f:	0f 84 a6 00 00 00    	je     801057bb <sys_open+0x12b>
  struct proc *curproc = myproc();
80105715:	e8 06 e1 ff ff       	call   80103820 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105ae7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105aea:	e8 31 dd ff ff       	call   80103820 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105bc6:	e8 e5 e6 ff ff       	call   801042b0 <kill>
...
80105be3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105be6:	e8 35 dc ff ff       	call   80103820 <myproc>
...
80105c60:	68 60 80 11 80       	push   $0x80118060
...
80105c6d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105c70:	8b 1d a0 88 11 80    	mov    0x801188a0,%ebx
  while(ticks - ticks0 < n){
...
80105c83:	68 60 80 11 80       	push   $0x80118060
80105c88:	68 a0 88 11 80       	push   $0x801188a0
80105c8d:	e8 3e e5 ff ff       	call   801041d0 <sleep>
  while(ticks - ticks0 < n){
80105c92:	a1 a0 88 11 80       	mov    0x801188a0,%eax
...
80105c9f:	73 2f                	jae    80105cd0 <sys_sleep+0x90>
    if(myproc()->killed){
80105ca1:	e8 7a db ff ff       	call   80103820 <myproc>
...
80105cb0:	68 60 80 11 80       	push   $0x80118060
...
80105cd3:	68 60 80 11 80       	push   $0x80118060
...
80105cf4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105cf7:	68 60 80 11 80       	push   $0x80118060
80105cfc:	e8 1f ed ff ff       	call   80104a20 <acquire>
  xticks = ticks;
80105d01:	8b 1d a0 88 11 80    	mov    0x801188a0,%ebx
  release(&tickslock);
80105d07:	c7 04 24 60 80 11 80 	movl   $0x80118060,(%esp)
...
80105d43:	e8 08 e6 ff ff       	call   80104350 <sigprocmask>
...
80105db2:	e8 a9 e7 ff ff       	call   80104560 <sigaction>
...
80105dd3:	5d                   	pop    %ebp
  return sigret();
80105dd4:	e9 97 e9 ff ff       	jmp    80104770 <sigret>
...
80105df1:	54                   	push   %esp
  call handle_signals
80105df2:	e8 d9 e8 ff ff       	call   801046d0 <handle_signals>
  addl $4, %esp
...
80105e27:	c7 04 c5 a2 80 11 80 	movl   $0x8e000008,-0x7fee7f5e(,%eax,8)
80105e2e:	08 00 00 8e 
80105e32:	66 89 14 c5 a0 80 11 	mov    %dx,-0x7fee7f60(,%eax,8)
80105e39:	80 
80105e3a:	c1 ea 10             	shr    $0x10,%edx
80105e3d:	66 89 14 c5 a6 80 11 	mov    %dx,-0x7fee7f5a(,%eax,8)
80105e44:	80 
  for(i = 0; i < 256; i++)
...
80105e54:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e57:	c7 05 a2 82 11 80 08 	movl   $0xef000008,0x801182a2
80105e5e:	00 00 ef 
  initlock(&tickslock, "time");
80105e61:	68 25 7f 10 80       	push   $0x80107f25
80105e66:	68 60 80 11 80       	push   $0x80118060
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e6b:	66 a3 a0 82 11 80    	mov    %ax,0x801182a0
80105e71:	c1 e8 10             	shr    $0x10,%eax
80105e74:	66 a3 a6 82 11 80    	mov    %ax,0x801182a6
  initlock(&tickslock, "time");
...
80105e9b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105e9f:	b8 a0 80 11 80       	mov    $0x801180a0,%eax
...
80105ef0:	e8 2b d9 ff ff       	call   80103820 <myproc>
...
80105f10:	e8 eb d8 ff ff       	call   80103800 <cpuid>
...
80105f21:	e8 fa d8 ff ff       	call   80103820 <myproc>
80105f26:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105f29:	e8 f2 d8 ff ff       	call   80103820 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105f52:	e8 c9 d8 ff ff       	call   80103820 <myproc>
...
80105f5e:	e8 bd d8 ff ff       	call   80103820 <myproc>
80105f63:	85 c0                	test   %eax,%eax
80105f65:	74 1d                	je     80105f84 <trap+0xc4>
80105f67:	e8 b4 d8 ff ff       	call   80103820 <myproc>
...
80105f8d:	e8 8e d8 ff ff       	call   80103820 <myproc>
...
80105f96:	74 68                	je     80106000 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f98:	e8 83 d8 ff ff       	call   80103820 <myproc>
80105f9d:	85 c0                	test   %eax,%eax
80105f9f:	74 19                	je     80105fba <trap+0xfa>
80105fa1:	e8 7a d8 ff ff       	call   80103820 <myproc>
...
80105fe0:	e8 3b ef ff ff       	call   80104f20 <syscall>
    if(myproc()->killed)
80105fe5:	e8 36 d8 ff ff       	call   80103820 <myproc>
...
8010600d:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80106010:	e8 eb d7 ff ff       	call   80103800 <cpuid>
...
8010601d:	e8 8e c7 ff ff       	call   801027b0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106022:	e8 f9 d7 ff ff       	call   80103820 <myproc>
...
8010607f:	e8 7c d7 ff ff       	call   80103800 <cpuid>
...
80106096:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106099:	e8 82 d7 ff ff       	call   80103820 <myproc>
...
801060e3:	68 60 80 11 80       	push   $0x80118060
801060e8:	e8 33 e9 ff ff       	call   80104a20 <acquire>
      wakeup(&ticks);
801060ed:	c7 04 24 a0 88 11 80 	movl   $0x801188a0,(%esp)
      ticks++;
801060f4:	83 05 a0 88 11 80 01 	addl   $0x1,0x801188a0
      wakeup(&ticks);
801060fb:	e8 90 e1 ff ff       	call   80104290 <wakeup>
      release(&tickslock);
80106100:	c7 04 24 60 80 11 80 	movl   $0x80118060,(%esp)
...
80106114:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106117:	e8 e4 d6 ff ff       	call   80103800 <cpuid>
...
80106ef3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ef6:	e8 05 c9 ff ff       	call   80103800 <cpuid>
...
80106f80:	a1 a4 88 11 80       	mov    0x801188a4,%eax
{
...
80106fcf:	e8 ac c7 ff ff       	call   80103780 <mycpu>
80106fd4:	89 c6                	mov    %eax,%esi
80106fd6:	e8 a5 c7 ff ff       	call   80103780 <mycpu>
80106fdb:	89 c7                	mov    %eax,%edi
80106fdd:	e8 9e c7 ff ff       	call   80103780 <mycpu>
80106fe2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106fe5:	83 c7 08             	add    $0x8,%edi
80106fe8:	e8 93 c7 ff ff       	call   80103780 <mycpu>
...
8010745b:	a3 a4 88 11 80       	mov    %eax,0x801188a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
