...
80100997:	e9 34 3a 00 00       	jmp    801043d0 <procdump>
...
80100d08:	e8 23 40 00 00       	call   80104d30 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d63:	e8 58 62 00 00       	call   80106fc0 <switchuvm>
  freevm(oldpgdir);
80100d68:	89 3c 24             	mov    %edi,(%esp)
80100d6b:	e8 00 66 00 00       	call   80107370 <freevm>
  return 0;
...
80100dd0:	e8 2b 3b 00 00       	call   80104900 <initlock>
}
...
80100df1:	e8 4a 3c 00 00       	call   80104a40 <acquire>
...
80100e21:	e8 da 3c 00 00       	call   80104b00 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e3a:	e8 c1 3c 00 00       	call   80104b00 <release>
}
...
80100e5f:	e8 dc 3b 00 00       	call   80104a40 <acquire>
  if(f->ref < 1)
...
80100e7c:	e8 7f 3c 00 00       	call   80104b00 <release>
  return f;
}
...
80100eb1:	e8 8a 3b 00 00       	call   80104a40 <acquire>
  if(f->ref < 1)
...
80100edb:	5d                   	pop    %ebp
    release(&ftable.lock);
80100edc:	e9 1f 3c 00 00       	jmp    80104b00 <release>
...
80100f05:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f08:	e8 f3 3b 00 00       	call   80104b00 <release>
  if(ff.type == FD_PIPE)
...
801012c5:	e8 86 38 00 00       	call   80104b50 <memset>
  log_write(bp);
...
8010130a:	e8 31 37 00 00       	call   80104a40 <acquire>
...
8010136f:	e8 8c 37 00 00       	call   80104b00 <release>
...
8010139a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010139d:	e8 5e 37 00 00       	call   80104b00 <release>
      return ip;
...
801014c1:	e8 3a 37 00 00       	call   80104c00 <memmove>
  brelse(bp);
...
801014f6:	e8 05 34 00 00       	call   80104900 <initlock>
...
8010150f:	e8 bc 32 00 00       	call   801047d0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015ee:	e8 5d 35 00 00       	call   80104b50 <memset>
      dip->type = type;
...
80101691:	e8 6a 35 00 00       	call   80104c00 <memmove>
  log_write(bp);
...
801016bf:	e8 7c 33 00 00       	call   80104a40 <acquire>
  ip->ref++;
...
80101702:	e8 09 31 00 00       	call   80104810 <acquiresleep>
  if(ip->valid == 0){
...
80101778:	e8 83 34 00 00       	call   80104c00 <memmove>
    brelse(bp);
...
801017d3:	e8 d8 30 00 00       	call   801048b0 <holdingsleep>
...
801017ee:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017ef:	e9 7c 30 00 00       	jmp    80104870 <releasesleep>
    panic("iunlock");
...
80101820:	e8 eb 2f 00 00       	call   80104810 <acquiresleep>
...
8010183a:	e8 31 30 00 00       	call   80104870 <releasesleep>
  acquire(&icache.lock);
8010183f:	c7 04 24 e0 19 11 80 	movl   $0x801119e0,(%esp)
80101846:	e8 f5 31 00 00       	call   80104a40 <acquire>
  ip->ref--;
...
80101a65:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a67:	e8 94 31 00 00       	call   80104c00 <memmove>
    brelse(bp);
...
80101b63:	e8 98 30 00 00       	call   80104c00 <memmove>
    log_write(bp);
...
80101bfe:	e8 6d 30 00 00       	call   80104c70 <strncmp>
}
80101c03:	c9                   	leave  
80101c04:	c3                   	ret    
...
80101c5d:	e8 0e 30 00 00       	call   80104c70 <strncmp>
      continue;
...
80101ce9:	e8 52 2d 00 00       	call   80104a40 <acquire>
  ip->ref++;
80101cee:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cf2:	c7 04 24 e0 19 11 80 	movl   $0x801119e0,(%esp)
80101cf9:	e8 02 2e 00 00       	call   80104b00 <release>
...
80101d55:	e8 a6 2e 00 00       	call   80104c00 <memmove>
    path++;
...
80101de8:	e8 13 2e 00 00       	call   80104c00 <memmove>
    name[len] = 0;
...
80101edd:	e8 ee 2d 00 00       	call   80104cd0 <strncpy>
  de.inum = inum;
...
80101f28:	68 4a 7f 10 80       	push   $0x80107f4a
...
80102070:	e8 8b 28 00 00       	call   80104900 <initlock>
...
801020ee:	e8 4d 29 00 00       	call   80104a40 <acquire>
...
80102151:	e8 6a 21 00 00       	call   801042c0 <wakeup>
...
8010216f:	e8 8c 29 00 00       	call   80104b00 <release>
...
8010218e:	e8 1d 27 00 00       	call   801048b0 <holdingsleep>
...
801021c8:	e8 73 28 00 00       	call   80104a40 <acquire>
...
80102235:	c9                   	leave  
  release(&idelock);
80102236:	e9 c5 28 00 00       	jmp    80104b00 <release>
8010223b:	90                   	nop
...
801023a2:	e8 a9 27 00 00       	call   80104b50 <memset>
...
801023da:	c9                   	leave  
    release(&kmem.lock);
801023db:	e9 20 27 00 00       	jmp    80104b00 <release>
    acquire(&kmem.lock);
801023e0:	83 ec 0c             	sub    $0xc,%esp
801023e3:	68 40 36 11 80       	push   $0x80113640
801023e8:	e8 53 26 00 00       	call   80104a40 <acquire>
...
80102465:	e8 96 24 00 00       	call   80104900 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102553:	e8 e8 24 00 00       	call   80104a40 <acquire>
  r = kmem.freelist;
...
80102581:	e8 7a 25 00 00       	call   80104b00 <release>
  return (char*)r;
...
80102997:	e8 04 22 00 00       	call   80104ba0 <memcmp>
...
80102ac4:	e8 37 21 00 00       	call   80104c00 <memmove>
...
80102b74:	e8 87 1d 00 00       	call   80104900 <initlock>
  readsb(dev, &sb);
80102b79:	58                   	pop    %eax
...
80102c0b:	e8 30 1e 00 00       	call   80104a40 <acquire>
...
80102c7e:	e8 bd 1d 00 00       	call   80104a40 <acquire>
  log.outstanding -= 1;
...
80102cbc:	e8 3f 1e 00 00       	call   80104b00 <release>
}
...
80102d16:	e8 e5 1e 00 00       	call   80104c00 <memmove>
...
80102d5f:	e8 dc 1c 00 00       	call   80104a40 <acquire>
    wakeup(&log);
...
80102d72:	00 00 00 
    wakeup(&log);
80102d75:	e8 46 15 00 00       	call   801042c0 <wakeup>
    release(&log.lock);
80102d7a:	c7 04 24 80 36 11 80 	movl   $0x80113680,(%esp)
80102d81:	e8 7a 1d 00 00       	call   80104b00 <release>
...
80102da0:	e8 1b 15 00 00       	call   801042c0 <wakeup>
  release(&log.lock);
80102da5:	c7 04 24 80 36 11 80 	movl   $0x80113680,(%esp)
80102dac:	e8 4f 1d 00 00       	call   80104b00 <release>
...
80102e0e:	e8 2d 1c 00 00       	call   80104a40 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102e5c:	c9                   	leave  
  release(&log.lock);
80102e5d:	e9 9e 1c 00 00       	jmp    80104b00 <release>
...
80102ec2:	e8 e9 2f 00 00       	call   80105eb0 <idtinit>
...
80102ee3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102ee6:	e8 b5 40 00 00       	call   80106fa0 <switchkvm>
  seginit();
80102eeb:	e8 20 40 00 00       	call   80106f10 <seginit>
  lapicinit();
...
80102f44:	e8 97 32 00 00       	call   801061e0 <uartinit>
  pinit();         // process table
80102f49:	e8 12 08 00 00       	call   80103760 <pinit>
  tvinit();        // trap vectors
80102f4e:	e8 dd 2e 00 00       	call   80105e30 <tvinit>
  binit();         // buffer cache
...
80102f74:	e8 87 1c 00 00       	call   80104c00 <memmove>
...
80103054:	e8 47 1b 00 00       	call   80104ba0 <memcmp>
...
80103112:	e8 89 1a 00 00       	call   80104ba0 <memcmp>
...
80103361:	e8 9a 15 00 00       	call   80104900 <initlock>
  (*f0)->type = FD_PIPE;
...
801033bf:	e8 7c 16 00 00       	call   80104a40 <acquire>
  if(writable){
...
801033df:	e8 dc 0e 00 00       	call   801042c0 <wakeup>
...
80103403:	5d                   	pop    %ebp
    release(&p->lock);
80103404:	e9 f7 16 00 00       	jmp    80104b00 <release>
...
80103424:	e8 97 0e 00 00       	call   801042c0 <wakeup>
...
80103434:	e8 c7 16 00 00       	call   80104b00 <release>
    kfree((char*)p);
...
8010345d:	e8 de 15 00 00       	call   80104a40 <acquire>
  for(i = 0; i < n; i++){
...
801034b4:	e8 07 0e 00 00       	call   801042c0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801034b9:	5a                   	pop    %edx
801034ba:	59                   	pop    %ecx
...
801034f4:	e8 07 16 00 00       	call   80104b00 <release>
        return -1;
...
80103543:	e8 78 0d 00 00       	call   801042c0 <wakeup>
  release(&p->lock);
80103548:	89 1c 24             	mov    %ebx,(%esp)
8010354b:	e8 b0 15 00 00       	call   80104b00 <release>
  return n;
...
80103570:	e8 cb 14 00 00       	call   80104a40 <acquire>
...
801035de:	e8 1d 15 00 00       	call   80104b00 <release>
      return -1;
...
80103637:	e8 84 0c 00 00       	call   801042c0 <wakeup>
  release(&p->lock);
8010363c:	89 34 24             	mov    %esi,(%esp)
8010363f:	e8 bc 14 00 00       	call   80104b00 <release>
  return i;
...
8010371b:	e8 e0 13 00 00       	call   80104b00 <release>
  if (first) {
...
80103770:	e8 8b 11 00 00       	call   80104900 <initlock>
}
...
80103824:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103827:	e8 44 11 00 00       	call   80104970 <pushcli>
  c = mycpu();
8010382c:	e8 4f ff ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103831:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103837:	e8 74 11 00 00       	call   801049b0 <popcli>
}
...
80103859:	83 ec 24             	sub    $0x24,%esp
  pushcli();
8010385c:	e8 0f 11 00 00       	call   80104970 <pushcli>
...
8010388b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  popcli();
8010388e:	e8 1d 11 00 00       	call   801049b0 <popcli>
}
...
801038a5:	83 ec 10             	sub    $0x10,%esp
  pushcli();
801038a8:	e8 c3 10 00 00       	call   80104970 <pushcli>
...
801038fd:	74 b9                	je     801038b8 <allocproc+0x18>
  popcli();
801038ff:	e8 ac 10 00 00       	call   801049b0 <popcli>
  p->pid = allocpid();
...
80103929:	c7 40 14 11 5e 10 80 	movl   $0x80105e11,0x14(%eax)
...
80103938:	e8 13 12 00 00       	call   80104b50 <memset>
...
80103986:	31 f6                	xor    %esi,%esi
      popcli();
80103988:	e8 23 10 00 00       	call   801049b0 <popcli>
}
...
801039c4:	e8 27 3a 00 00       	call   801073f0 <setupkvm>
...
801039e5:	e8 e6 36 00 00       	call   801070d0 <inituvm>
...
801039fa:	e8 51 11 00 00       	call   80104b50 <memset>
...
80103a59:	e8 d2 12 00 00       	call   80104d30 <safestrcpy>
  p->cwd = namei("/");
...
80103a6a:	89 46 68             	mov    %eax,0x68(%esi)
  pushcli();
80103a6d:	e8 fe 0e 00 00       	call   80104970 <pushcli>
  int ret_val = 1;
...
80103aa5:	e8 b6 cb ff ff       	call   80100660 <cprintf>
  popcli();
80103aaa:	e8 01 0f 00 00       	call   801049b0 <popcli>
}
...
80103ae5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103ae8:	e8 83 0e 00 00       	call   80104970 <pushcli>
  c = mycpu();
80103aed:	e8 8e fc ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103af2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103af8:	e8 b3 0e 00 00       	call   801049b0 <popcli>
  if(n > 0){
...
80103b0c:	e8 af 34 00 00       	call   80106fc0 <switchuvm>
  return 0;
...
80103b66:	83 ec 2c             	sub    $0x2c,%esp
  pushcli();
80103b69:	e8 02 0e 00 00       	call   80104970 <pushcli>
  c = mycpu();
80103b6e:	e8 0d fc ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103b73:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b79:	e8 32 0e 00 00       	call   801049b0 <popcli>
  if((np = allocproc()) == 0){
...
80103b98:	e8 23 39 00 00       	call   801074c0 <copyuvm>
...
80103c44:	e8 e7 10 00 00       	call   80104d30 <safestrcpy>
  pid = np->pid;
80103c49:	8b 77 10             	mov    0x10(%edi),%esi
  pushcli();
80103c4c:	e8 1f 0d 00 00       	call   80104970 <pushcli>
  int ret_val = 1;
...
80103cfe:	e8 3d 0d 00 00       	call   80104a40 <acquire>
...
80103d8d:	e8 2e 32 00 00       	call   80106fc0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103d92:	5b                   	pop    %ebx
80103d93:	58                   	pop    %eax
80103d94:	ff 76 1c             	pushl  0x1c(%esi)
80103d97:	ff 75 d0             	pushl  -0x30(%ebp)
80103d9a:	e8 ec 0f 00 00       	call   80104d8b <swtch>
      switchkvm();
80103d9f:	e8 fc 31 00 00       	call   80106fa0 <switchkvm>
...
80103e80:	e8 7b 0c 00 00       	call   80104b00 <release>
    sti();
...
80103e94:	53                   	push   %ebx
  pushcli();
80103e95:	e8 d6 0a 00 00       	call   80104970 <pushcli>
  c = mycpu();
80103e9a:	e8 e1 f8 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103e9f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ea5:	e8 06 0b 00 00       	call   801049b0 <popcli>
  if(mycpu()->ncli != 1)
...
80103edf:	e8 a7 0e 00 00       	call   80104d8b <swtch>
  mycpu()->intena = intena;
...
80103f26:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103f29:	e8 42 0a 00 00       	call   80104970 <pushcli>
  c = mycpu();
80103f2e:	e8 4d f8 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103f33:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f39:	e8 72 0a 00 00       	call   801049b0 <popcli>
  if(curproc == initproc)
...
80103f97:	e8 a4 0a 00 00       	call   80104a40 <acquire>
...
8010404c:	e8 ef 09 00 00       	call   80104a40 <acquire>
  pushcli();
80104051:	e8 1a 09 00 00       	call   80104970 <pushcli>
  c = mycpu();
80104056:	e8 25 f7 ff ff       	call   80103780 <mycpu>
  p = c->proc;
8010405b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104061:	e8 4a 09 00 00       	call   801049b0 <popcli>
  int ret_val = 1;
...
8010409e:	e8 5d 0a 00 00       	call   80104b00 <release>
}
...
801040c8:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801040cb:	e8 a0 08 00 00       	call   80104970 <pushcli>
  c = mycpu();
801040d0:	e8 ab f6 ff ff       	call   80103780 <mycpu>
  p = c->proc;
801040d5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040db:	e8 d0 08 00 00       	call   801049b0 <popcli>
  if(p == 0)
...
80104100:	e8 3b 09 00 00       	call   80104a40 <acquire>
    release(lk);
80104105:	89 34 24             	mov    %esi,(%esp)
80104108:	e8 f3 09 00 00       	call   80104b00 <release>
...
80104153:	e8 a8 09 00 00       	call   80104b00 <release>
    acquire(lk);
80104158:	89 34 24             	mov    %esi,(%esp)
8010415b:	e8 e0 08 00 00       	call   80104a40 <acquire>
...
8010420a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010420d:	85 c9                	test   %ecx,%ecx
...
80104226:	74 78                	je     801042a0 <pass1804+0x96>
80104228:	8b 47 24             	mov    0x24(%edi),%eax
8010422b:	85 c0                	test   %eax,%eax
8010422d:	75 71                	jne    801042a0 <pass1804+0x96>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
8010422f:	83 ec 08             	sub    $0x8,%esp
80104232:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104235:	68 20 3d 11 80       	push   $0x80113d20
8010423a:	57                   	push   %edi
8010423b:	e8 80 fe ff ff       	call   801040c0 <sleep>
    havekids = 0;
80104240:	83 c4 10             	add    $0x10,%esp
80104243:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80104246:	eb 88                	jmp    801041d0 <wait+0x30>
80104248:	90                   	nop
80104249:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        kfree(p->kstack);
80104250:	83 ec 0c             	sub    $0xc,%esp
80104253:	ff 76 08             	pushl  0x8(%esi)
        pid = p->pid;
80104256:	8b 5e 10             	mov    0x10(%esi),%ebx
        kfree(p->kstack);
80104259:	e8 12 e1 ff ff       	call   80102370 <kfree>
        freevm(p->pgdir);
8010425e:	5a                   	pop    %edx
8010425f:	ff 76 04             	pushl  0x4(%esi)
        p->kstack = 0;
80104262:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
        freevm(p->pgdir);
80104269:	e8 02 31 00 00       	call   80107370 <freevm>
        release(&ptable.lock);
8010426e:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
        p->pid = 0;
80104275:	c7 46 10 00 00 00 00 	movl   $0x0,0x10(%esi)
        p->parent = 0;
8010427c:	c7 46 14 00 00 00 00 	movl   $0x0,0x14(%esi)
        p->name[0] = 0;
80104283:	c6 46 6c 00          	movb   $0x0,0x6c(%esi)
        p->killed = 0;
80104287:	c7 46 24 00 00 00 00 	movl   $0x0,0x24(%esi)
        release(&ptable.lock);
8010428e:	e8 6d 08 00 00       	call   80104b00 <release>
        return pid;
80104293:	83 c4 10             	add    $0x10,%esp
}
80104296:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104299:	89 d8                	mov    %ebx,%eax
8010429b:	5b                   	pop    %ebx
8010429c:	5e                   	pop    %esi
8010429d:	5f                   	pop    %edi
8010429e:	5d                   	pop    %ebp
...
801042a0:	83 ec 0c             	sub    $0xc,%esp
      return -1;
801042a3:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
      release(&ptable.lock);
801042a8:	68 20 3d 11 80       	push   $0x80113d20
801042ad:	e8 4e 08 00 00       	call   80104b00 <release>
      return -1;
801042b2:	83 c4 10             	add    $0x10,%esp
801042b5:	eb df                	jmp    80104296 <pass1804+0x8c>
...
801042cf:	e8 6c 07 00 00       	call   80104a40 <acquire>
  wakeup1(chan);
801042d4:	89 d8                	mov    %ebx,%eax
801042d6:	e8 85 f3 ff ff       	call   80103660 <wakeup1>
  release(&ptable.lock);
801042db:	83 c4 10             	add    $0x10,%esp
801042de:	c7 45 08 20 3d 11 80 	movl   $0x80113d20,0x8(%ebp)
}
801042e5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801042e8:	c9                   	leave  
  release(&ptable.lock);
801042e9:	e9 12 08 00 00       	jmp    80104b00 <release>
...
801042f5:	8b 75 0c             	mov    0xc(%ebp),%esi
801042f8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(signum < SIG_MIN || signum > SIG_MAX)
801042fb:	83 fe 1f             	cmp    $0x1f,%esi
801042fe:	77 7c                	ja     8010437c <kill+0x8c>
  acquire(&ptable.lock);
80104300:	83 ec 0c             	sub    $0xc,%esp
80104303:	68 20 3d 11 80       	push   $0x80113d20
80104308:	e8 33 07 00 00       	call   80104a40 <acquire>
8010430d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104310:	b8 54 3d 11 80       	mov    $0x80113d54,%eax
80104315:	eb 15                	jmp    8010432c <kill+0x3c>
80104317:	89 f6                	mov    %esi,%esi
80104319:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80104320:	05 0c 01 00 00       	add    $0x10c,%eax
80104325:	3d 54 80 11 80       	cmp    $0x80118054,%eax
8010432a:	73 34                	jae    80104360 <kill+0x70>
    if(p->pid == pid){
8010432c:	39 58 10             	cmp    %ebx,0x10(%eax)
8010432f:	75 ef                	jne    80104320 <kill+0x30>
      p->psignals |= 1 << signum;
80104331:	89 f1                	mov    %esi,%ecx
80104333:	ba 01 00 00 00       	mov    $0x1,%edx
      release(&ptable.lock);
80104338:	83 ec 0c             	sub    $0xc,%esp
      p->psignals |= 1 << signum;
8010433b:	d3 e2                	shl    %cl,%edx
8010433d:	09 50 7c             	or     %edx,0x7c(%eax)
      release(&ptable.lock);
80104340:	68 20 3d 11 80       	push   $0x80113d20
80104345:	e8 b6 07 00 00       	call   80104b00 <release>
      return 0;
...
80104368:	e8 93 07 00 00       	call   80104b00 <release>
  return -1;
...
80104394:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104397:	e8 d4 05 00 00       	call   80104970 <pushcli>
  c = mycpu();
8010439c:	e8 df f3 ff ff       	call   80103780 <mycpu>
  p = c->proc;
801043a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801043a7:	e8 04 06 00 00       	call   801049b0 <popcli>
  curproc->sigmask = mask;
801043ac:	8b 55 08             	mov    0x8(%ebp),%edx
  uint old = curproc -> sigmask;
801043af:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
  curproc->sigmask = mask;
801043b5:	89 93 80 00 00 00    	mov    %edx,0x80(%ebx)
}
801043bb:	83 c4 04             	add    $0x4,%esp
801043be:	5b                   	pop    %ebx
801043bf:	5d                   	pop    %ebp
801043c0:	c3                   	ret    
801043c1:	eb 0d                	jmp    801043d0 <procdump>
801043c3:	90                   	nop
801043c4:	90                   	nop
801043c5:	90                   	nop
801043c6:	90                   	nop
...
801043d6:	8d 75 e8             	lea    -0x18(%ebp),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043d9:	bb 54 3d 11 80       	mov    $0x80113d54,%ebx
{
...
801043eb:	68 63 81 10 80       	push   $0x80108163
801043f0:	e8 6b c2 ff ff       	call   80100660 <cprintf>
801043f5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043f8:	81 c3 0c 01 00 00    	add    $0x10c,%ebx
801043fe:	81 fb 54 80 11 80    	cmp    $0x80118054,%ebx
80104404:	0f 83 86 00 00 00    	jae    80104490 <procdump+0xc0>
    if(p->state == UNUSED)
8010440a:	8b 43 0c             	mov    0xc(%ebx),%eax
8010440d:	85 c0                	test   %eax,%eax
8010440f:	74 e7                	je     801043f8 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104411:	83 f8 09             	cmp    $0x9,%eax
      state = "???";
80104414:	ba dc 7d 10 80       	mov    $0x80107ddc,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104419:	77 11                	ja     8010442c <procdump+0x5c>
8010441b:	8b 14 85 40 7e 10 80 	mov    -0x7fef81c0(,%eax,4),%edx
      state = "???";
80104422:	b8 dc 7d 10 80       	mov    $0x80107ddc,%eax
80104427:	85 d2                	test   %edx,%edx
80104429:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
8010442c:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010442f:	50                   	push   %eax
80104430:	52                   	push   %edx
80104431:	ff 73 10             	pushl  0x10(%ebx)
80104434:	68 e0 7d 10 80       	push   $0x80107de0
80104439:	e8 22 c2 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
8010443e:	83 c4 10             	add    $0x10,%esp
80104441:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80104445:	75 a1                	jne    801043e8 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104447:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010444a:	83 ec 08             	sub    $0x8,%esp
8010444d:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104450:	50                   	push   %eax
80104451:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104454:	8b 40 0c             	mov    0xc(%eax),%eax
80104457:	83 c0 08             	add    $0x8,%eax
8010445a:	50                   	push   %eax
8010445b:	e8 c0 04 00 00       	call   80104920 <getcallerpcs>
80104460:	83 c4 10             	add    $0x10,%esp
80104463:	90                   	nop
80104464:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      for(i=0; i<10 && pc[i] != 0; i++)
80104468:	8b 17                	mov    (%edi),%edx
8010446a:	85 d2                	test   %edx,%edx
8010446c:	0f 84 76 ff ff ff    	je     801043e8 <procdump+0x18>
        cprintf(" %p", pc[i]);
80104472:	83 ec 08             	sub    $0x8,%esp
80104475:	83 c7 04             	add    $0x4,%edi
80104478:	52                   	push   %edx
80104479:	68 e1 76 10 80       	push   $0x801076e1
8010447e:	e8 dd c1 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104483:	83 c4 10             	add    $0x10,%esp
80104486:	39 fe                	cmp    %edi,%esi
80104488:	75 de                	jne    80104468 <procdump+0x98>
8010448a:	e9 59 ff ff ff       	jmp    801043e8 <procdump+0x18>
8010448f:	90                   	nop
}
...
801044a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801044a7:	e8 c4 04 00 00       	call   80104970 <pushcli>
  c = mycpu();
801044ac:	e8 cf f2 ff ff       	call   80103780 <mycpu>
  p = c->proc;
801044b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801044b7:	e8 f4 04 00 00       	call   801049b0 <popcli>
  if(p->state == SLEEPING)
801044bc:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
  p->killed = 1;
801044c0:	c7 43 24 01 00 00 00 	movl   $0x1,0x24(%ebx)
  if(p->state == SLEEPING)
801044c7:	75 07                	jne    801044d0 <sigkill_handler+0x30>
    p->state = RUNNABLE;
801044c9:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
}
...
801044e4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801044e7:	e8 84 04 00 00       	call   80104970 <pushcli>
  c = mycpu();
801044ec:	e8 8f f2 ff ff       	call   80103780 <mycpu>
  p = c->proc;
801044f1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801044f7:	e8 b4 04 00 00       	call   801049b0 <popcli>
801044fc:	b8 01 00 00 00       	mov    $0x1,%eax
  if(p-> state == SLEEPING)
80104501:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80104505:	74 0c                	je     80104513 <sigstop_handler+0x33>
  p->frozen = 1;
80104507:	c7 83 08 01 00 00 01 	movl   $0x1,0x108(%ebx)
8010450e:	00 00 00 
  return 0;
...
80104524:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104527:	e8 44 04 00 00       	call   80104970 <pushcli>
  c = mycpu();
8010452c:	e8 4f f2 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80104531:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104537:	e8 74 04 00 00       	call   801049b0 <popcli>
}
8010453c:	31 c0                	xor    %eax,%eax
  p->frozen = 0;
8010453e:	c7 83 08 01 00 00 00 	movl   $0x0,0x108(%ebx)
80104545:	00 00 00 
}
...
8010455c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    new_sighandlers[i] = old_sighandlers[i];
80104560:	8b 14 81             	mov    (%ecx,%eax,4),%edx
80104563:	89 14 83             	mov    %edx,(%ebx,%eax,4)
  for(i = 0; i < SIG_HANDLERS_NUM; i++) {
80104566:	83 c0 01             	add    $0x1,%eax
80104569:	83 f8 20             	cmp    $0x20,%eax
8010456c:	75 f2                	jne    80104560 <copySigHandlers+0x10>
  }
}
8010456e:	5b                   	pop    %ebx
8010456f:	5d                   	pop    %ebp
80104570:	c3                   	ret    
80104571:	eb 0d                	jmp    80104580 <sigaction>
80104573:	90                   	nop
80104574:	90                   	nop
80104575:	90                   	nop
80104576:	90                   	nop
...
8010458c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  pushcli();
8010458f:	e8 dc 03 00 00       	call   80104970 <pushcli>
  c = mycpu();
80104594:	e8 e7 f1 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80104599:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
8010459f:	e8 0c 04 00 00       	call   801049b0 <popcli>
  struct proc* curproc = myproc();

  if(signum == SIGSTOP || signum == SIGKILL) // they cannot be modified, blocked or ignored
801045a4:	8d 56 f7             	lea    -0x9(%esi),%edx
801045a7:	b8 01 00 00 00       	mov    $0x1,%eax
801045ac:	83 e2 f7             	and    $0xfffffff7,%edx
801045af:	74 2f                	je     801045e0 <sigaction+0x60>
    return 1;

  if(oldact != null) {
801045b1:	8b 4d 10             	mov    0x10(%ebp),%ecx
801045b4:	8d 84 b7 84 00 00 00 	lea    0x84(%edi,%esi,4),%eax
801045bb:	85 c9                	test   %ecx,%ecx
801045bd:	74 0d                	je     801045cc <sigaction+0x4c>
...
80104601:	ff 73 18             	pushl  0x18(%ebx)
80104604:	ff 73 08             	pushl  0x8(%ebx)
80104607:	e8 f4 05 00 00       	call   80104c00 <memmove>
    p->tf_backup = (struct trapframe*)p->kstack;
8010460c:	8b 43 08             	mov    0x8(%ebx),%eax
...
8010460f:	8b 53 18             	mov    0x18(%ebx),%edx

    sigret_caller_addr = (char*)p->tf->esp;

    memmove((char*)p->tf->esp, sigret_caller_start, sigret_size);
80104612:	83 c4 0c             	add    $0xc,%esp
    p->tf_backup = (struct trapframe*)p->kstack;
80104615:	89 83 04 01 00 00    	mov    %eax,0x104(%ebx)
    sigret_size = sigret_caller_end - sigret_caller_start;
8010461b:	b8 28 5e 10 80       	mov    $0x80105e28,%eax
80104620:	2d 21 5e 10 80       	sub    $0x80105e21,%eax
    p->tf->esp = p->tf->esp - sigret_size; // make room for sigret code
80104625:	29 42 44             	sub    %eax,0x44(%edx)
    sigret_caller_addr = (char*)p->tf->esp;
80104628:	8b 53 18             	mov    0x18(%ebx),%edx
8010462b:	8b 7a 44             	mov    0x44(%edx),%edi
    memmove((char*)p->tf->esp, sigret_caller_start, sigret_size);
8010462e:	50                   	push   %eax
8010462f:	68 21 5e 10 80       	push   $0x80105e21
80104634:	57                   	push   %edi
80104635:	e8 c6 05 00 00       	call   80104c00 <memmove>

    // pushing signum
    p->tf->esp = p->tf->esp-UINT_SIZE;
8010463a:	8b 43 18             	mov    0x18(%ebx),%eax
    p->tf->esp = p->tf->esp-UINT_SIZE;
...
8010463d:	83 c4 10             	add    $0x10,%esp
    p->tf->esp = p->tf->esp-UINT_SIZE;
80104640:	83 68 44 04          	subl   $0x4,0x44(%eax)
    *((uint*)(p->tf->esp)) = sig;
80104644:	8b 43 18             	mov    0x18(%ebx),%eax
80104647:	8b 40 44             	mov    0x44(%eax),%eax
8010464a:	89 30                	mov    %esi,(%eax)
    p->tf->esp = p->tf->esp-UINT_SIZE;
8010464c:	8b 43 18             	mov    0x18(%ebx),%eax
8010464f:	83 68 44 04          	subl   $0x4,0x44(%eax)
    *((uint*)(p->tf->esp)) = (uint)sigret_caller_addr;
80104653:	8b 43 18             	mov    0x18(%ebx),%eax
80104656:	8b 40 44             	mov    0x44(%eax),%eax
80104659:	89 38                	mov    %edi,(%eax)
    p->tf->eip = (uint)&((struct sigaction*)p->sig_handlers[sig])->sa_handler;
8010465b:	8b 94 b3 84 00 00 00 	mov    0x84(%ebx,%esi,4),%edx
80104662:	8b 43 18             	mov    0x18(%ebx),%eax
80104665:	89 50 38             	mov    %edx,0x38(%eax)
}
80104668:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010466b:	5b                   	pop    %ebx
8010466c:	5e                   	pop    %esi
8010466d:	5f                   	pop    %edi
8010466e:	5d                   	pop    %ebp
...
80104675:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104678:	e8 f3 02 00 00       	call   80104970 <pushcli>
  c = mycpu();
8010467d:	e8 fe f0 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80104682:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104688:	e8 23 03 00 00       	call   801049b0 <popcli>
  struct proc *p = myproc();
  if(p->sig_handlers[sig] == SIG_IGN)
8010468d:	8b 84 9e 84 00 00 00 	mov    0x84(%esi,%ebx,4),%eax
80104694:	83 f8 01             	cmp    $0x1,%eax
80104697:	74 11                	je     801046aa <handleSignal+0x3a>
  {
    // do nothing
  }
...
8010469b:	74 1b                	je     801046b8 <handleSignal+0x48>
...
801046a2:	e8 49 ff ff ff       	call   801045f0 <user_handler>
...
801046b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    switch (sig) 
801046b8:	83 fb 11             	cmp    $0x11,%ebx
801046bb:	74 23                	je     801046e0 <handleSignal+0x70>
801046bd:	83 fb 13             	cmp    $0x13,%ebx
801046c0:	75 0e                	jne    801046d0 <handleSignal+0x60>
}
...
801046c7:	5d                   	pop    %ebp
        sigcont_handler();
801046c8:	e9 53 fe ff ff       	jmp    80104520 <sigcont_handler>
...
801046d5:	5d                   	pop    %ebp
        sigkill_handler();
801046d6:	e9 c5 fd ff ff       	jmp    801044a0 <sigkill_handler>
801046db:	90                   	nop
...
801046e5:	5d                   	pop    %ebp
        sigstop_handler();
801046e6:	e9 f5 fd ff ff       	jmp    801044e0 <sigstop_handler>
801046eb:	90                   	nop
801046ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801046f0 <handle_signals>:
...
801046f6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801046f9:	e8 72 02 00 00       	call   80104970 <pushcli>
  c = mycpu();
801046fe:	e8 7d f0 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80104703:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104709:	e8 a2 02 00 00       	call   801049b0 <popcli>
  struct proc *p = myproc();
  uint sig;

  if(p == 0)
8010470e:	85 f6                	test   %esi,%esi
80104710:	74 6e                	je     80104780 <handle_signals+0x90>
    return;
...
80104715:	bf 01 00 00 00       	mov    $0x1,%edi
  acquire(&ptable.lock);
8010471a:	68 20 3d 11 80       	push   $0x80113d20
8010471f:	e8 1c 03 00 00       	call   80104a40 <acquire>
80104724:	83 c4 10             	add    $0x10,%esp
  for (sig = SIG_MIN; sig <= SIG_MAX; sig++) {
80104727:	31 c9                	xor    %ecx,%ecx
80104729:	eb 0d                	jmp    80104738 <handle_signals+0x48>
8010472b:	90                   	nop
8010472c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104730:	83 c1 01             	add    $0x1,%ecx
80104733:	83 f9 20             	cmp    $0x20,%ecx
80104736:	74 38                	je     80104770 <handle_signals+0x80>
  if((p->psignals & (1 << sig))  && !(p->sigmask & (1 << sig))) {
80104738:	89 fb                	mov    %edi,%ebx
8010473a:	d3 e3                	shl    %cl,%ebx
8010473c:	85 5e 7c             	test   %ebx,0x7c(%esi)
8010473f:	74 ef                	je     80104730 <handle_signals+0x40>
80104741:	85 9e 80 00 00 00    	test   %ebx,0x80(%esi)
80104747:	75 e7                	jne    80104730 <handle_signals+0x40>
    handleSignal(sig);           // handle it
80104749:	83 ec 0c             	sub    $0xc,%esp
8010474c:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
8010474f:	51                   	push   %ecx
80104750:	e8 1b ff ff ff       	call   80104670 <handleSignal>
    p->psignals ^= 1 << sig;     // turn off this bit
80104755:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104758:	31 5e 7c             	xor    %ebx,0x7c(%esi)
8010475b:	83 c4 10             	add    $0x10,%esp
  for (sig = SIG_MIN; sig <= SIG_MAX; sig++) {
8010475e:	83 c1 01             	add    $0x1,%ecx
80104761:	83 f9 20             	cmp    $0x20,%ecx
80104764:	75 d2                	jne    80104738 <handle_signals+0x48>
...
80104773:	68 20 3d 11 80       	push   $0x80113d20
80104778:	e8 83 03 00 00       	call   80104b00 <release>
  return;
...
80104794:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104797:	e8 d4 01 00 00       	call   80104970 <pushcli>
  c = mycpu();
8010479c:	e8 df ef ff ff       	call   80103780 <mycpu>
  p = c->proc;
801047a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801047a7:	e8 04 02 00 00       	call   801049b0 <popcli>
  struct proc* p = myproc();
  memmove(p->tf, p->tf_backup, sizeof(struct trapframe)); // trapframe restore
801047ac:	83 ec 04             	sub    $0x4,%esp
801047af:	6a 4c                	push   $0x4c
801047b1:	ff b3 04 01 00 00    	pushl  0x104(%ebx)
801047b7:	ff 73 18             	pushl  0x18(%ebx)
801047ba:	e8 41 04 00 00       	call   80104c00 <memmove>
  return 0;
...
801047da:	68 68 7e 10 80       	push   $0x80107e68
...
80104835:	e8 86 f8 ff ff       	call   801040c0 <sleep>
  while (lk->locked) {
...
80104843:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104849:	e8 d2 ef ff ff       	call   80103820 <myproc>
...
80104894:	e8 27 fa ff ff       	call   801042c0 <wakeup>
  release(&lk->lk);
...
801048d3:	e8 48 ef ff ff       	call   80103820 <myproc>
...
80104979:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010497a:	e8 01 ee ff ff       	call   80103780 <mycpu>
...
8010498f:	e8 ec ed ff ff       	call   80103780 <mycpu>
...
801049dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801049e0:	e8 9b ed ff ff       	call   80103780 <mycpu>
...
801049f5:	68 73 7e 10 80       	push   $0x80107e73
801049fa:	e8 91 b9 ff ff       	call   80100390 <panic>
    panic("popcli");
801049ff:	83 ec 0c             	sub    $0xc,%esp
80104a02:	68 8a 7e 10 80       	push   $0x80107e8a
...
80104a28:	e8 53 ed ff ff       	call   80103780 <mycpu>
...
80104a84:	e8 f7 ec ff ff       	call   80103780 <mycpu>
...
80104ae7:	68 91 7e 10 80       	push   $0x80107e91
...
80104b3c:	68 99 7e 10 80       	push   $0x80107e99
...
80104da7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104daa:	e8 71 ea ff ff       	call   80103820 <myproc>
...
80104de7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104dea:	e8 31 ea ff ff       	call   80103820 <myproc>
...
80104e55:	e8 c6 e9 ff ff       	call   80103820 <myproc>
...
80104e63:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104e66:	e8 b5 e9 ff ff       	call   80103820 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104ea8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104eab:	e8 70 e9 ff ff       	call   80103820 <myproc>
...
80104f44:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104f47:	e8 d4 e8 ff ff       	call   80103820 <myproc>
...
80104f5c:	8b 14 85 c0 7e 10 80 	mov    -0x7fef8140(,%eax,4),%edx
...
80104f80:	68 a1 7e 10 80       	push   $0x80107ea1
...
80104fb7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104fba:	e8 a1 cf ff ff       	call   80101f60 <nameiparent>
...
80104fd0:	e8 0b c7 ff ff       	call   801016e0 <ilock>
...
80104fdc:	e8 2f cc ff ff       	call   80101c10 <dirlookup>
...
80104fee:	e8 7d c9 ff ff       	call   80101970 <iunlockput>
    ilock(ip);
...
8010502a:	e8 41 c5 ff ff       	call   80101570 <ialloc>
...
80105040:	e8 9b c6 ff ff       	call   801016e0 <ilock>
  ip->major = major;
...
80105061:	e8 ca c5 ff ff       	call   80101630 <iupdate>
...
80105078:	e8 03 ce ff ff       	call   80101e80 <dirlink>
...
8010508c:	e8 df c8 ff ff       	call   80101970 <iunlockput>
  return ip;
...
801050a4:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
801050a6:	e8 c5 c8 ff ff       	call   80101970 <iunlockput>
    return 0;
...
801050c9:	e8 62 c5 ff ff       	call   80101630 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801050ce:	83 c4 0c             	add    $0xc,%esp
801050d1:	ff 77 04             	pushl  0x4(%edi)
801050d4:	68 40 7f 10 80       	push   $0x80107f40
801050d9:	57                   	push   %edi
801050da:	e8 a1 cd ff ff       	call   80101e80 <dirlink>
...
801050ec:	68 3f 7f 10 80       	push   $0x80107f3f
801050f1:	57                   	push   %edi
801050f2:	e8 89 cd ff ff       	call   80101e80 <dirlink>
...
80105105:	68 33 7f 10 80       	push   $0x80107f33
...
8010511a:	68 42 7f 10 80       	push   $0x80107f42
8010511f:	e8 6c b2 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80105124:	83 ec 0c             	sub    $0xc,%esp
80105127:	68 24 7f 10 80       	push   $0x80107f24
...
80105164:	e8 b7 e6 ff ff       	call   80103820 <myproc>
...
801051a9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801051ab:	e8 70 e6 ff ff       	call   80103820 <myproc>
...
801051d2:	e8 79 bc ff ff       	call   80100e50 <filedup>
  return fd;
...
8010524d:	e8 6e bd ff ff       	call   80100fc0 <fileread>
...
801052bd:	e8 8e bd ff ff       	call   80101050 <filewrite>
...
8010530b:	e8 90 bb ff ff       	call   80100ea0 <fileclose>
  return 0;
...
80105364:	e8 07 bc ff ff       	call   80100f70 <filestat>
...
801053b2:	0f 88 e2 00 00 00    	js     8010549a <sys_link+0x11a>
  begin_op();
801053b8:	e8 43 d8 ff ff       	call   80102c00 <begin_op>
  if((ip = namei(old)) == 0){
801053bd:	83 ec 0c             	sub    $0xc,%esp
801053c0:	ff 75 d4             	pushl  -0x2c(%ebp)
801053c3:	e8 78 cb ff ff       	call   80101f40 <namei>
...
801053d9:	e8 02 c3 ff ff       	call   801016e0 <ilock>
  if(ip->type == T_DIR){
...
801053f8:	e8 33 c2 ff ff       	call   80101630 <iupdate>
  iunlock(ip);
801053fd:	89 1c 24             	mov    %ebx,(%esp)
80105400:	e8 bb c3 ff ff       	call   801017c0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105405:	58                   	pop    %eax
80105406:	5a                   	pop    %edx
80105407:	57                   	push   %edi
80105408:	ff 75 d0             	pushl  -0x30(%ebp)
8010540b:	e8 50 cb ff ff       	call   80101f60 <nameiparent>
...
8010541d:	e8 be c2 ff ff       	call   801016e0 <ilock>
...
80105433:	e8 48 ca ff ff       	call   80101e80 <dirlink>
...
80105443:	e8 28 c5 ff ff       	call   80101970 <iunlockput>
  iput(ip);
80105448:	89 1c 24             	mov    %ebx,(%esp)
8010544b:	e8 c0 c3 ff ff       	call   80101810 <iput>
  end_op();
80105450:	e8 1b d8 ff ff       	call   80102c70 <end_op>
  return 0;
...
8010546c:	e8 ff c4 ff ff       	call   80101970 <iunlockput>
    goto bad;
80105471:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80105474:	83 ec 0c             	sub    $0xc,%esp
80105477:	53                   	push   %ebx
80105478:	e8 63 c2 ff ff       	call   801016e0 <ilock>
  ip->nlink--;
8010547d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105482:	89 1c 24             	mov    %ebx,(%esp)
80105485:	e8 a6 c1 ff ff       	call   80101630 <iupdate>
  iunlockput(ip);
8010548a:	89 1c 24             	mov    %ebx,(%esp)
8010548d:	e8 de c4 ff ff       	call   80101970 <iunlockput>
  end_op();
80105492:	e8 d9 d7 ff ff       	call   80102c70 <end_op>
  return -1;
...
801054ab:	e8 c0 c4 ff ff       	call   80101970 <iunlockput>
    end_op();
801054b0:	e8 bb d7 ff ff       	call   80102c70 <end_op>
    return -1;
801054b5:	83 c4 10             	add    $0x10,%esp
801054b8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054bd:	eb 9b                	jmp    8010545a <sys_link+0xda>
    end_op();
801054bf:	e8 ac d7 ff ff       	call   80102c70 <end_op>
    return -1;
...
801054ef:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
801054f2:	e8 09 d7 ff ff       	call   80102c00 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801054f7:	83 ec 08             	sub    $0x8,%esp
801054fa:	53                   	push   %ebx
801054fb:	ff 75 c0             	pushl  -0x40(%ebp)
801054fe:	e8 5d ca ff ff       	call   80101f60 <nameiparent>
...
80105514:	e8 c7 c1 ff ff       	call   801016e0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105519:	58                   	pop    %eax
8010551a:	5a                   	pop    %edx
8010551b:	68 40 7f 10 80       	push   $0x80107f40
80105520:	53                   	push   %ebx
80105521:	e8 ca c6 ff ff       	call   80101bf0 <namecmp>
...
80105534:	68 3f 7f 10 80       	push   $0x80107f3f
80105539:	53                   	push   %ebx
8010553a:	e8 b1 c6 ff ff       	call   80101bf0 <namecmp>
...
80105553:	e8 b8 c6 ff ff       	call   80101c10 <dirlookup>
...
80105569:	e8 72 c1 ff ff       	call   801016e0 <ilock>
  if(ip->nlink < 1)
...
8010559d:	e8 1e c5 ff ff       	call   80101ac0 <writei>
...
801055bd:	e8 ae c3 ff ff       	call   80101970 <iunlockput>
  ip->nlink--;
801055c2:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801055c7:	89 1c 24             	mov    %ebx,(%esp)
801055ca:	e8 61 c0 ff ff       	call   80101630 <iupdate>
  iunlockput(ip);
801055cf:	89 1c 24             	mov    %ebx,(%esp)
801055d2:	e8 99 c3 ff ff       	call   80101970 <iunlockput>
  end_op();
801055d7:	e8 94 d6 ff ff       	call   80102c70 <end_op>
  return 0;
...
80105614:	e8 a7 c3 ff ff       	call   801019c0 <readi>
...
8010562c:	e8 3f c3 ff ff       	call   80101970 <iunlockput>
    goto bad;
80105631:	83 c4 10             	add    $0x10,%esp
  iunlockput(dp);
80105634:	83 ec 0c             	sub    $0xc,%esp
80105637:	56                   	push   %esi
80105638:	e8 33 c3 ff ff       	call   80101970 <iunlockput>
  end_op();
8010563d:	e8 2e d6 ff ff       	call   80102c70 <end_op>
  return -1;
...
80105659:	e8 d2 bf ff ff       	call   80101630 <iupdate>
...
8010566b:	e9 71 ff ff ff       	jmp    801055e1 <sys_unlink+0x111>
    end_op();
80105670:	e8 fb d5 ff ff       	call   80102c70 <end_op>
    return -1;
...
801056e2:	0f 88 04 01 00 00    	js     801057ec <sys_open+0x13c>
  ...
  begin_op();
801056e8:	e8 13 d5 ff ff       	call   80102c00 <begin_op>
...
801056fd:	e8 3e c8 ff ff       	call   80101f40 <namei>
...
80105713:	e8 c8 bf ff ff       	call   801016e0 <ilock>
...
8010575c:	e8 5f c0 ff ff       	call   801017c0 <iunlock>
  end_op();
80105761:	e8 0a d5 ff ff       	call   80102c70 <end_op>
...
801057bb:	0f 85 65 ff ff ff    	jne    80105726 <sys_open+0x76>
      end_op();
801057c1:	e8 aa d4 ff ff       	call   80102c70 <end_op>
      return -1;
...
801057df:	e8 8c c1 ff ff       	call   80101970 <iunlockput>
    end_op();
801057e4:	e8 87 d4 ff ff       	call   80102c70 <end_op>
    return -1;
...
801057fc:	e8 9f b6 ff ff       	call   80100ea0 <fileclose>
...
80105813:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105816:	e8 e5 d3 ff ff       	call   80102c00 <begin_op>
...
8010584f:	e8 1c c1 ff ff       	call   80101970 <iunlockput>
  end_op();
80105854:	e8 17 d4 ff ff       	call   80102c70 <end_op>
  return 0;
...
8010585f:	c3                   	ret    
    end_op();
80105860:	e8 0b d4 ff ff       	call   80102c70 <end_op>
    return -1;
...
80105873:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105876:	e8 85 d3 ff ff       	call   80102c00 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801058de:	e8 8d c0 ff ff       	call   80101970 <iunlockput>
  end_op();
801058e3:	e8 88 d3 ff ff       	call   80102c70 <end_op>
  return 0;
...
801058ef:	90                   	nop
    end_op();
801058f0:	e8 7b d3 ff ff       	call   80102c70 <end_op>
    return -1;
...
80105905:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105908:	e8 13 df ff ff       	call   80103820 <myproc>
8010590d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010590f:	e8 ec d2 ff ff       	call   80102c00 <begin_op>
...
8010592f:	e8 0c c6 ff ff       	call   80101f40 <namei>
...
80105941:	e8 9a bd ff ff       	call   801016e0 <ilock>
  if(ip->type != T_DIR){
...
80105954:	e8 67 be ff ff       	call   801017c0 <iunlock>
  iput(curproc->cwd);
80105959:	58                   	pop    %eax
8010595a:	ff 76 68             	pushl  0x68(%esi)
8010595d:	e8 ae be ff ff       	call   80101810 <iput>
  end_op();
80105962:	e8 09 d3 ff ff       	call   80102c70 <end_op>
  curproc->cwd = ip;
...
80105984:	e8 e7 bf ff ff       	call   80101970 <iunlockput>
    end_op();
80105989:	e8 e2 d2 ff ff       	call   80102c70 <end_op>
    return -1;
...
80105999:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    end_op();
801059a0:	e8 cb d2 ff ff       	call   80102c70 <end_op>
    return -1;
...
80105acc:	e8 cf d7 ff ff       	call   801032a0 <pipealloc>
...
80105adf:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105ae1:	e8 3a dd ff ff       	call   80103820 <myproc>
...
80105b07:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105b0a:	e8 11 dd ff ff       	call   80103820 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105b5e:	e8 3d b3 ff ff       	call   80100ea0 <fileclose>
    fileclose(wf);
80105b63:	58                   	pop    %eax
80105b64:	ff 75 e4             	pushl  -0x1c(%ebp)
80105b67:	e8 34 b3 ff ff       	call   80100ea0 <fileclose>
    return -1;
...
80105b83:	5d                   	pop    %ebp
  return fork();
80105b84:	e9 d7 df ff ff       	jmp    80103b60 <fork>
...
80105b93:	83 ec 08             	sub    $0x8,%esp
  exit();
80105b96:	e8 85 e3 ff ff       	call   80103f20 <exit>
...
80105ba3:	5d                   	pop    %ebp
  return wait();
80105ba4:	e9 f7 e5 ff ff       	jmp    801041a0 <wait>
...
80105bc6:	78 28                	js     80105bf0 <sys_kill+0x40>
    return -1;
...
80105c03:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105c06:	e8 15 dc ff ff       	call   80103820 <myproc>
...
80105c36:	e8 a5 de ff ff       	call   80103ae0 <growproc>
...
80105c80:	68 60 80 11 80       	push   $0x80118060
...
80105c8d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105c90:	8b 1d a0 88 11 80    	mov    0x801188a0,%ebx
  while(ticks - ticks0 < n){
...
80105ca3:	68 60 80 11 80       	push   $0x80118060
80105ca8:	68 a0 88 11 80       	push   $0x801188a0
80105cad:	e8 0e e4 ff ff       	call   801040c0 <sleep>
  while(ticks - ticks0 < n){
80105cb2:	a1 a0 88 11 80       	mov    0x801188a0,%eax
...
80105cd0:	68 60 80 11 80       	push   $0x80118060
80105cd5:	e8 26 ee ff ff       	call   80104b00 <release>
      return -1;
...
80105cf3:	68 60 80 11 80       	push   $0x80118060
80105cf8:	e8 03 ee ff ff       	call   80104b00 <release>
  return 0;
...
80105d14:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105d17:	68 60 80 11 80       	push   $0x80118060
80105d1c:	e8 1f ed ff ff       	call   80104a40 <acquire>
  xticks = ticks;
80105d21:	8b 1d a0 88 11 80    	mov    0x801188a0,%ebx
  release(&tickslock);
80105d27:	c7 04 24 60 80 11 80 	movl   $0x80118060,(%esp)
80105d2e:	e8 cd ed ff ff       	call   80104b00 <release>
  return xticks;
}
...
80105d4c:	e8 ff f0 ff ff       	call   80104e50 <argint>
80105d51:	83 c4 10             	add    $0x10,%esp
80105d54:	85 c0                	test   %eax,%eax
80105d56:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80105d5b:	78 10                	js     80105d6d <sys_sigprocmask+0x2d>
    return -1;
  return sigprocmask(new_mask);
80105d5d:	83 ec 0c             	sub    $0xc,%esp
80105d60:	ff 75 f4             	pushl  -0xc(%ebp)
80105d63:	e8 28 e6 ff ff       	call   80104390 <sigprocmask>
80105d68:	83 c4 10             	add    $0x10,%esp
80105d6b:	89 c2                	mov    %eax,%edx
}
80105d6d:	89 d0                	mov    %edx,%eax
80105d6f:	c9                   	leave  
80105d70:	c3                   	ret    
80105d71:	eb 0d                	jmp    80105d80 <sys_sigaction>
80105d73:	90                   	nop
80105d74:	90                   	nop
80105d75:	90                   	nop
80105d76:	90                   	nop
...
80105d86:	8d 45 ec             	lea    -0x14(%ebp),%eax
...
80105dcf:	ff 75 ec             	pushl  -0x14(%ebp)
80105dd2:	e8 a9 e7 ff ff       	call   80104580 <sigaction>
...
80105df3:	5d                   	pop    %ebp
  return sigret();
80105df4:	e9 97 e9 ff ff       	jmp    80104790 <sigret>
...
80105e08:	54                   	push   %esp
  call trap
80105e09:	e8 d2 00 00 00       	call   80105ee0 <trap>
  addl $4, %esp
...
trapret:
  call handle_signals
80105e11:	e8 da e8 ff ff       	call   801046f0 <handle_signals>
  popal
80105e16:	61                   	popa   
  popl %gs
80105e17:	0f a9                	pop    %gs
  popl %fs
80105e19:	0f a1                	pop    %fs
  popl %es
80105e1b:	07                   	pop    %es
  popl %ds
80105e1c:	1f                   	pop    %ds
...
sigret_caller_start:
  movl $SYS_sigret, %eax
80105e21:	b8 18 00 00 00       	mov    $0x18,%eax
  int $T_SYSCALL
80105e26:	cd 40                	int    $0x40

80105e28 <sigret_caller_end>:
80105e28:	66 90                	xchg   %ax,%ax
...
80105e47:	c7 04 c5 a2 80 11 80 	movl   $0x8e000008,-0x7fee7f5e(,%eax,8)
80105e4e:	08 00 00 8e 
80105e52:	66 89 14 c5 a0 80 11 	mov    %dx,-0x7fee7f60(,%eax,8)
80105e59:	80 
80105e5a:	c1 ea 10             	shr    $0x10,%edx
80105e5d:	66 89 14 c5 a6 80 11 	mov    %dx,-0x7fee7f5a(,%eax,8)
80105e64:	80 
  for(i = 0; i < 256; i++)
...
80105e6f:	a1 08 b1 10 80       	mov    0x8010b108,%eax

  initlock(&tickslock, "time");
80105e74:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e77:	c7 05 a2 82 11 80 08 	movl   $0xef000008,0x801182a2
80105e7e:	00 00 ef 
  initlock(&tickslock, "time");
80105e81:	68 85 7f 10 80       	push   $0x80107f85
80105e86:	68 60 80 11 80       	push   $0x80118060
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e8b:	66 a3 a0 82 11 80    	mov    %ax,0x801182a0
80105e91:	c1 e8 10             	shr    $0x10,%eax
80105e94:	66 a3 a6 82 11 80    	mov    %ax,0x801182a6
  initlock(&tickslock, "time");
80105e9a:	e8 61 ea ff ff       	call   80104900 <initlock>
}
...
80105ebb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105ebf:	b8 a0 80 11 80       	mov    $0x801180a0,%eax
...
80105f00:	ff 24 85 2c 80 10 80 	jmp    *-0x7fef7fd4(,%eax,4)
...
80105f10:	e8 0b d9 ff ff       	call   80103820 <myproc>
...
80105f30:	e8 cb d8 ff ff       	call   80103800 <cpuid>
...
80105f41:	e8 da d8 ff ff       	call   80103820 <myproc>
...
80105f65:	68 e8 7f 10 80       	push   $0x80107fe8
80105f6a:	e8 f1 a6 ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105f6f:	83 c4 20             	add    $0x20,%esp
80105f72:	e8 a9 d8 ff ff       	call   80103820 <myproc>
...
80105f7e:	e8 9d d8 ff ff       	call   80103820 <myproc>
80105f83:	85 c0                	test   %eax,%eax
80105f85:	74 1d                	je     80105fa4 <trap+0xc4>
80105f87:	e8 94 d8 ff ff       	call   80103820 <myproc>
...
80105fad:	e8 6e d8 ff ff       	call   80103820 <myproc>
80105fb2:	83 78 0c 07          	cmpl   $0x7,0xc(%eax)
80105fb6:	74 68                	je     80106020 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105fb8:	e8 63 d8 ff ff       	call   80103820 <myproc>
80105fbd:	85 c0                	test   %eax,%eax
80105fbf:	74 19                	je     80105fda <trap+0xfa>
80105fc1:	e8 5a d8 ff ff       	call   80103820 <myproc>
...
80105fe2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105fe8:	e8 33 d8 ff ff       	call   80103820 <myproc>
...
80105ffd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80106000:	e8 3b ef ff ff       	call   80104f40 <syscall>
    if(myproc()->killed)
80106005:	e8 16 d8 ff ff       	call   80103820 <myproc>
...
8010603d:	e8 6e c7 ff ff       	call   801027b0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106042:	e8 d9 d7 ff ff       	call   80103820 <myproc>
...
80106054:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80106058:	e8 13 c6 ff ff       	call   80102670 <kbdintr>
    lapiceoi();
...
8010609f:	e8 5c d7 ff ff       	call   80103800 <cpuid>
801060a4:	56                   	push   %esi
801060a5:	53                   	push   %ebx
801060a6:	50                   	push   %eax
801060a7:	68 90 7f 10 80       	push   $0x80107f90
801060ac:	e8 af a5 ff ff       	call   80100660 <cprintf>
    lapiceoi();
801060b1:	e8 fa c6 ff ff       	call   801027b0 <lapiceoi>
    break;
801060b6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801060b9:	e8 62 d7 ff ff       	call   80103820 <myproc>
...
80106103:	68 60 80 11 80       	push   $0x80118060
80106108:	e8 33 e9 ff ff       	call   80104a40 <acquire>
      wakeup(&ticks);
8010610d:	c7 04 24 a0 88 11 80 	movl   $0x801188a0,(%esp)
      ticks++;
80106114:	83 05 a0 88 11 80 01 	addl   $0x1,0x801188a0
      wakeup(&ticks);
8010611b:	e8 a0 e1 ff ff       	call   801042c0 <wakeup>
      release(&tickslock);
80106120:	c7 04 24 60 80 11 80 	movl   $0x80118060,(%esp)
80106127:	e8 d4 e9 ff ff       	call   80104b00 <release>
8010612c:	83 c4 10             	add    $0x10,%esp
8010612f:	e9 09 ff ff ff       	jmp    8010603d <trap+0x15d>
80106134:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106137:	e8 c4 d6 ff ff       	call   80103800 <cpuid>
...
80106145:	68 b4 7f 10 80       	push   $0x80107fb4
8010614a:	e8 11 a5 ff ff       	call   80100660 <cprintf>
      panic("trap");
8010614f:	83 c4 14             	add    $0x14,%esp
80106152:	68 8a 7f 10 80       	push   $0x80107f8a
...
801061b5:	e8 16 c6 ff ff       	call   801027d0 <microdelay>
...
8010624c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010624f:	bb ac 80 10 80       	mov    $0x801080ac,%ebx
  ioapicenable(IRQ_COM1, 0);
80106254:	6a 00                	push   $0x0
80106256:	6a 04                	push   $0x4
80106258:	e8 d3 c0 ff ff       	call   80102330 <ioapicenable>
...
80106da4:	e8 77 b7 ff ff       	call   80102520 <kalloc>
...
80106dba:	e8 91 dd ff ff       	call   80104b50 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106e5d:	68 b4 80 10 80       	push   $0x801080b4
...
80106eb4:	e8 b7 b4 ff ff       	call   80102370 <kfree>
      *pte = 0;
...
80106f13:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106f16:	e8 e5 c8 ff ff       	call   80103800 <cpuid>
...
80106fa0:	a1 a4 88 11 80       	mov    0x801188a4,%eax
{
...
80106fe4:	0f 84 c2 00 00 00    	je     801070ac <switchuvm+0xec>
  pushcli();
80106fea:	e8 81 d9 ff ff       	call   80104970 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106fef:	e8 8c c7 ff ff       	call   80103780 <mycpu>
80106ff4:	89 c6                	mov    %eax,%esi
80106ff6:	e8 85 c7 ff ff       	call   80103780 <mycpu>
80106ffb:	89 c7                	mov    %eax,%edi
80106ffd:	e8 7e c7 ff ff       	call   80103780 <mycpu>
80107002:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107005:	83 c7 08             	add    $0x8,%edi
80107008:	e8 73 c7 ff ff       	call   80103780 <mycpu>
...
801070eb:	77 49                	ja     80107136 <inituvm+0x66>
  mem = kalloc();
801070ed:	e8 2e b4 ff ff       	call   80102520 <kalloc>
  memset(mem, 0, PGSIZE);
...
801070ff:	e8 4c da ff ff       	call   80104b50 <memset>
...
80107130:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107131:	e9 ca da ff ff       	jmp    80104c00 <memmove>
    panic("inituvm: more than a page");
80107136:	83 ec 0c             	sub    $0xc,%esp
80107139:	68 f9 80 10 80       	push   $0x801080f9
...
801071c1:	e8 fa a7 ff ff       	call   801019c0 <readi>
...
8010725b:	e8 f0 d8 ff ff       	call   80104b50 <memset>
...
80107289:	0f 86 81 00 00 00    	jbe    80107310 <allocuvm+0x100>
    mem = kalloc();
8010728f:	e8 8c b2 ff ff       	call   80102520 <kalloc>
    if(mem == 0){
...
8010729d:	68 31 81 10 80       	push   $0x80108131
...
801072d3:	68 49 81 10 80       	push   $0x80108149
...
801072fb:	e8 70 b0 ff ff       	call   80102370 <kfree>
      return 0;
...
801073be:	e8 ad af ff ff       	call   80102370 <kfree>
...
801073d3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801073d4:	e9 97 af ff ff       	jmp    80102370 <kfree>
    panic("freevm: no pgdir");
801073d9:	83 ec 0c             	sub    $0xc,%esp
801073dc:	68 65 81 10 80       	push   $0x80108165
...
801073f5:	e8 26 b1 ff ff       	call   80102520 <kalloc>
...
80107410:	e8 3b d7 ff ff       	call   80104b50 <memset>
...
8010747b:	a3 a4 88 11 80       	mov    %eax,0x801188a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801074af:	68 76 81 10 80       	push   $0x80108176
...
80107500:	e8 fb d6 ff ff       	call   80104c00 <memmove>
...
80107555:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107558:	e8 c3 af ff ff       	call   80102520 <kalloc>
...
8010762f:	e8 cc d5 ff ff       	call   80104c00 <memmove>
    len -= n;
    buf += n;
